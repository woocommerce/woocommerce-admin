...
use \Automattic\WooCommerce\Admin\API\Themes;
...
class WC_Tests_API_Themes extends WC_REST_Unit_Test_Case {
	...
	public function test_missing_upload() {
		...
		$request  = new WP_REST_Request( 'POST', $this->endpoint . '/upload' );
	...
	public function test_schema() {
		...
		$request    = new WP_REST_Request( 'OPTIONS', $this->endpoint . '/upload' );
		$response   = $this->server->dispatch( $request );
		$data       = $response->get_data();
