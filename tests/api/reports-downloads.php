...
class WC_Tests_API_Reports_Downloads extends WC_REST_Unit_Test_Case {
	...
	public function test_get_report() {
		...
		$prod_download->set_file( plugin_dir_url( $this->wc_core_dir . '/woocommerce.php' ) . 'assets/images/help.png' );
		...
		$this->assertEquals( esc_url( plugin_dir_url( $this->wc_core_dir . '/woocommerce.php' ) . 'assets/images/help.png' ), $download_report['file_path'] );
	}
