...
describe( 'formatCurrency', () => {
	...
	it( 'should uses store currency settings, not locale-based', () => {
		global.wcSharedSettings.currency.code = 'JPY';
		global.wcSharedSettings.currency.precision = 3;
		global.wcSharedSettings.currency.decimal_separator = ',';
		global.wcSharedSettings.currency.thousand_separator = '.';
		global.wcSharedSettings.currency.price_format = '%2$s%1$s';
...
describe( 'getCurrencyFormatDecimal', () => {
	it( 'should round a number to 2 decimal places in USD', () => {
		global.wcSharedSettings.currency.precision = 2;
	...
	it( 'should round a number to 0 decimal places in JPY', () => {
		global.wcSharedSettings.currency.precision = 0;
