...
class Loader {
	...
	/**
	 * The script manifest generated by Webpack for js/css assets.
	 *
	 * @var mixed
	 */
	protected static $script_manifest = null;
	...
	public function __construct() {
		...
		*/
		...
		$json                  = file_get_contents( WC_ADMIN_ABSPATH . 'dist/manifest.json' );
		self::$script_manifest = json_decode( $json );
	}
	...
	public static function register_scripts() {
		...
		wp_register_script(
			'wc-csv',
			self::get_url_from_manifest( 'csv-export/index.js' ),
			array( 'moment' ),
			$js_file_version,
			true
		);
		...
		wp_register_script(
			'wc-currency',
			self::get_url_from_manifest( 'currency/index.js' ),
			array( 'wc-number' ),
			$js_file_version,
			true
		);
		...
		wp_register_script(
			'wc-navigation',
			self::get_url_from_manifest( 'navigation/index.js' ),
			array(),
			$js_file_version,
			true
		);
		...
		wp_register_script(
			'wc-number',
			self::get_url_from_manifest( 'number/index.js' ),
			array(),
			$js_file_version,
			true
		);
		...
		wp_register_script(
			'wc-tracks',
			self::get_url_from_manifest( 'tracks/index.js' ),
			array(),
			$js_file_version,
			true
		);
		...
		wp_register_script(
			'wc-date',
			self::get_url_from_manifest( 'date/index.js' ),
		...
		wp_register_script(
			'wc-store-data',
			self::get_url_from_manifest( 'data/index.js' ),
			array(),
			$js_file_version,
			true
		);
		...
		wp_register_script(
			'wc-components',
			self::get_url_from_manifest( 'components/index.js' ),
			array(
				'moment',
				'wp-api-fetch',
				'wp-data',
		...
		wp_register_style(
			'wc-components',
			self::get_url_from_manifest( 'components/style.css' ),
			array(),
			$css_file_version
		);
		...
		wp_register_style(
			'wc-components-ie',
			self::get_url_from_manifest( 'components/ie.css' ),
			array(),
			$css_file_version
		);
		...
		wp_register_script(
			WC_ADMIN_APP,
			self::get_url_from_manifest( 'app/index.js' ),
			array(
				'wp-core-data',
				'wc-components',
				'wp-date',
