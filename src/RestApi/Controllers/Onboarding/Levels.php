...
namespace WooCommerce\Admin\RestApi\Controllers\Onboarding;
 ...
 */
class Levels extends \WP_REST_Controller {
	/**
	 * Endpoint namespace.
	 *
	 * @var string
	...
	public function get_item_permissions_check( $request ) {
		if ( ! wc_rest_check_manager_permissions( 'settings', 'read' ) ) {
			return new \WP_Error( 'woocommerce_rest_cannot_view', __( 'Sorry, you cannot view this resource.', 'woocommerce-admin' ), array( 'status' => rest_authorization_required_code() ) );
		}
		return true;
	}
