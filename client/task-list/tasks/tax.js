	...
	getSteps() {
		...
		const steps = [
			...
			},
			{
				key: 'plugins',
				label: __(
					'Install Jetpack and WooCommerce Shipping & Tax',
					'woocommerce-admin'
				),
				description: __(
					'Jetpack and WooCommerce Shipping & Tax allow you to automate sales tax calculations',
					'woocommerce-admin'
				),
				content: (
					<Fragment>
						...
						{ ! tosAccepted && (
							...
							>
								{ interpolateComponents( {
									mixedString: __(
										'By installing Jetpack and WooCommerce Shipping & Tax you agree to the {{link}}Terms of Service{{/link}}.',
										'woocommerce-admin'
									),
									components: {
										link: (
		...
		return (
			<div className="woocommerce-task-tax__success">
				...
				<p>
					{ interpolateComponents( {
						mixedString: __(
							'{{strong}}Jetpack{{/strong}} and {{strong}}WooCommerce Shipping & Tax{{/strong}} ' +
