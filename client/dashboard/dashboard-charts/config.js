...
import { charts as ordersCharts } from 'client/analytics/report/orders/config';
import { charts as productsCharts } from 'client/analytics/report/products/config';
import { charts as revenueCharts } from 'client/analytics/report/revenue/config';
import { charts as couponsCharts } from 'client/analytics/report/coupons/config';
import { charts as taxesCharts } from 'client/analytics/report/taxes/config';
import { charts as downloadsCharts } from 'client/analytics/report/downloads/config';
