...
const getChartMeta = ( { query, isSingleProductView, isSingleProductVariable } ) => {
	const isCompareView =
...
const ProductsReport = props => {
	...
	const { getAdminLink, manageStock = 'no', stockStatuses = {}, locale, currency } = useSettings(
		'wc_admin',
		[ 'getAdminLink', 'manageStock', 'stockStatuses', 'locale', 'currency' ]
	);
