...
function getPluginErrorMessage(action, plugin) {
  ...
  switch (action) {
    case 'install':
      return Object(external_this_wp_i18n_["sprintf"])(Object(external_this_wp_i18n_["__"])('There was an error installing %s. Please try again.', 'woocommerce-admin'), pluginName);

    case 'connect':
      return Object(external_this_wp_i18n_["sprintf"])(Object(external_this_wp_i18n_["__"])('There was an error connecting to %s. Please try again.', 'woocommerce-admin'), pluginName);

    case 'activate':
    default:
      return Object(external_this_wp_i18n_["sprintf"])(Object(external_this_wp_i18n_["__"])('There was an error activating %s. Please try again.', 'woocommerce-admin'), pluginName);
  }
}
