...
var filters = Object(_wordpress_hooks__WEBPACK_IMPORTED_MODULE_1__["applyFilters"])(CATEGORY_REPORT_FILTERS_FILTER, [{
  ...
  filters: [{
    label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__["__"])('All Categories', 'woocommerce-admin'),
    value: 'all'
  }, {
    label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__["__"])('Single Category', 'woocommerce-admin'),
    ...
    subFilters: [{
      ...
      settings: {
        ...
        labels: {
          placeholder: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__["__"])('Type to search for a category', 'woocommerce-admin'),
          button: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__["__"])('Single Category', 'woocommerce-admin')
        }
      }
    }]
  }, {
    ...
    settings: {
      ...
      getLabels: lib_async_requests__WEBPACK_IMPORTED_MODULE_2__["getCategoryLabels"],
      labels: {
        helpText: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__["__"])('Check at least two categories below to compare', 'woocommerce-admin'),
        placeholder: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__["__"])('Search for categories to compare', 'woocommerce-admin'),
        title: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__["__"])('Compare Categories', 'woocommerce-admin'),
...
var CategoriesReport = /*#__PURE__*/function (_Component) {
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_2___default()(CategoriesReport, [{
    ...
    value: function getChartMeta() {
      ...
      var itemsLabel = isSingleCategoryView ? Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_8__["__"])('%d products', 'woocommerce-admin') : Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_8__["__"])('%d categories', 'woocommerce-admin');
      return {
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(CategoriesReportTable, [{
    ...
    value: function getHeadersContent() {
      return [{
        ...
        label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_7__["__"])('Products', 'woocommerce-admin'),
        key: 'products_count',
        isSortable: true,
        isNumeric: true
      }, {
    ...
    value: function getSummary(totals) {
      ...
      var currency = getCurrencyConfig();
      return [{
        label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_7__["_n"])('category', 'categories', totalResults, 'woocommerce-admin'),
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          query = _this$props.query;
      var labels = {
        helpText: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_7__["__"])('Check at least two categories below to compare', 'woocommerce-admin'),
        placeholder: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_7__["__"])('Search by category name', 'woocommerce-admin')
      };
      return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_6__["createElement"])(analytics_components_report_table__WEBPACK_IMPORTED_MODULE_14__["default"], {
        ...
        title: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_7__["__"])('Categories', 'woocommerce-admin'),
