...
/* harmony import */ var _lib_notices__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(555);
/* harmony import */ var _task_list_tasks_PaymentGatewaySuggestions_components_WCPay__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(563);
...
const PaymentRecommendations = () => {
  ...
  const setupPlugin = plugin => {
    ...
    installAndActivatePlugins([plugin.product]).then(() => {
      window.location.href = Object(_wc_admin_settings__WEBPACK_IMPORTED_MODULE_12__[/* getAdminLink */ "e"])(plugin['setup-link'].replace('/wp-admin/', ''));
    }).catch(response => {
