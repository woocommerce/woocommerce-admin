...
/* harmony default export */ var panels_orders = __webpack_exports__["default"] = (Object(compose["a" /* default */])(Object(external_this_wp_data_["withSelect"])(function (select, props) {
  ...
  if (hasActionableOrders) {
    ...
    var _isRequesting = isResolving('getReportItems', ['orders', ordersQuery]);
  ...
  var isRequesting = isResolving('getItems', ['orders', allOrdersQuery]);
  return {
