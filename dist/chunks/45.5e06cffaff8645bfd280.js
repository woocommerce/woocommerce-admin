...
var tax_Tax = /*#__PURE__*/function (_Component) {
  ...
  createClass_default()(Tax, [{
    ...
    value: function componentDidUpdate(prevProps) {
      ...
      var currentStepKey = currentStep && currentStep.key;
    ...
    value: function () {
      var _updateAutomatedTax = asyncToGenerator_default()( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
        var _this$props5, createNotice, updateAndPersistSettingsForGroup, generalSettings, taxSettings, automatedTaxEnabled;

        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _this$props5 = this.props, createNotice = _this$props5.createNotice, updateAndPersistSettingsForGroup = _this$props5.updateAndPersistSettingsForGroup, generalSettings = _this$props5.generalSettings, taxSettings = _this$props5.taxSettings;
