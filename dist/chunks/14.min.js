...
/* harmony import */ var _woocommerce_csv_export__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! @woocommerce/csv-export */ "@woocommerce/csv-export");
/* harmony import */ var _woocommerce_csv_export__WEBPACK_IMPORTED_MODULE_17___default = /*#__PURE__*/__webpack_require__.n(_woocommerce_csv_export__WEBPACK_IMPORTED_MODULE_17__);
...
/* harmony import */ var _woocommerce_tracks__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! @woocommerce/tracks */ "@woocommerce/tracks");
...
/* harmony import */ var _download_icon__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./download-icon */ "./client/analytics/components/report-table/download-icon.js");
/* harmony import */ var _report_error__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ../report-error */ "./client/analytics/components/report-error/index.js");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./utils */ "./client/analytics/components/report-table/utils.js");
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./style.scss */ "./client/analytics/components/report-table/style.scss");
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_23___default = /*#__PURE__*/__webpack_require__.n(_style_scss__WEBPACK_IMPORTED_MODULE_23__);
...
var ReportTable = function ReportTable(props) {
  ...
  var initialSelectedRows = query[compareParam] ? Object(_woocommerce_navigation__WEBPACK_IMPORTED_MODULE_16__["getIdsFromQuery"])(query[compareBy]) : [];
  ...
  var _useUserPreferences = Object(_woocommerce_data__WEBPACK_IMPORTED_MODULE_18__["useUserPreferences"])(),
  ...
  if (isError) {
    return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_5__["createElement"])(_report_error__WEBPACK_IMPORTED_MODULE_21__["default"], {
      isError: true
    });
  }
  ...
  var onPageChange = function onPageChange(newPage, source) {
    ...
    if (source) {
      if (source === 'goto') {
        Object(_woocommerce_tracks__WEBPACK_IMPORTED_MODULE_19__["recordEvent"])('analytics_table_go_to_page', {
          report: endpoint,
          page: newPage
        });
      } else {
        Object(_woocommerce_tracks__WEBPACK_IMPORTED_MODULE_19__["recordEvent"])('analytics_table_page_click', {
          report: endpoint,
          direction: source
        });
      }
  ...
  var trackTableSearch = function trackTableSearch() {
    ...
    Object(_woocommerce_tracks__WEBPACK_IMPORTED_MODULE_19__["recordEvent"])('analytics_table_filter', {
      report: endpoint
    });
  };

  var onSort = function onSort(key, direction) {
    Object(_woocommerce_navigation__WEBPACK_IMPORTED_MODULE_16__["onQueryChange"])('sort')(key, direction);
    var eventProps = {
      report: endpoint,
      column: key,
      direction: direction
    };
    Object(_woocommerce_tracks__WEBPACK_IMPORTED_MODULE_19__["recordEvent"])('analytics_table_sort', eventProps);
  };
  ...
  var onClickDownload = function onClickDownload() {
    ...
    if (data && data.length === totalResults) {
      Object(_woocommerce_csv_export__WEBPACK_IMPORTED_MODULE_17__["downloadCSVFile"])(Object(_woocommerce_csv_export__WEBPACK_IMPORTED_MODULE_17__["generateCSVFileName"])(title, params), Object(_woocommerce_csv_export__WEBPACK_IMPORTED_MODULE_17__["generateCSVDataFromTable"])(getHeadersContent(), getRowsContent(data)));
    } else {
      downloadType = 'email';
    ...
    Object(_woocommerce_tracks__WEBPACK_IMPORTED_MODULE_19__["recordEvent"])('analytics_table_download', {
      report: endpoint,
      rows: totalResults,
  ...
  var onCompare = function onCompare() {
    if (compareBy) {
      Object(_woocommerce_navigation__WEBPACK_IMPORTED_MODULE_16__["onQueryChange"])('compare')(compareBy, compareParam, selectedRows.join(','));
    }
  };
  ...
  var onSearchChange = function onSearchChange(values) {
    ...
    if (searchTerms.length) {
      ...
      Object(_woocommerce_navigation__WEBPACK_IMPORTED_MODULE_16__["updateQueryString"])(_objectSpread(_objectSpread((_objectSpread2 = {
        filter: undefined
  ...
  var searchWords = Object(_woocommerce_navigation__WEBPACK_IMPORTED_MODULE_16__["getSearchWords"])(query);
  ...
  var onColumnsChange = function onColumnsChange(shownColumns, toggledColumn) {
    ...
    if (toggledColumn) {
      ...
      Object(_woocommerce_tracks__WEBPACK_IMPORTED_MODULE_19__["recordEvent"])('analytics_table_header_toggle', eventProps);
    }
  ...
  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_5__["createElement"])(_wordpress_element__WEBPACK_IMPORTED_MODULE_5__["Fragment"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_5__["createElement"])("div", {
    ...
    }, labels.compareButton || Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_12__["__"])('Compare', 'woocommerce-admin')), searchBy && Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_5__["createElement"])(_woocommerce_components__WEBPACK_IMPORTED_MODULE_15__["Search"], {
    ...
    }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_5__["createElement"])(_download_icon__WEBPACK_IMPORTED_MODULE_20__["default"], null), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_5__["createElement"])("span", {
    ...
    isLoading: isLoading,
    onQueryChange: _woocommerce_navigation__WEBPACK_IMPORTED_MODULE_16__["onQueryChange"],
    onColumnsChange: onColumnsChange,
    onSort: onSort,
    onPageChange: onPageChange,
    rows: rows,
    rowsPerPage: parseInt(reportQuery.per_page, 10) || _woocommerce_data__WEBPACK_IMPORTED_MODULE_18__["QUERY_DEFAULTS"].pageSize,
    summary: summary,
...
ReportTable.propTypes = {
   ...
   */
  extendedItemsStoreName: prop_types__WEBPACK_IMPORTED_MODULE_14___default.a.string,
...
/* harmony default export */ __webpack_exports__["default"] = (Object(_wordpress_compose__WEBPACK_IMPORTED_MODULE_8__["compose"])(Object(_wordpress_data__WEBPACK_IMPORTED_MODULE_10__["withSelect"])(function (select, props) {
  ...
  var _select$getSetting = select(_woocommerce_data__WEBPACK_IMPORTED_MODULE_18__["SETTINGS_STORE_NAME"]).getSetting('wc_admin', 'wcAdminSettings'),
  ...
  var primaryData = getSummary ? Object(_woocommerce_data__WEBPACK_IMPORTED_MODULE_18__["getReportChartData"])({
  ...
  var queriedTableData = tableData || Object(_woocommerce_data__WEBPACK_IMPORTED_MODULE_18__["getReportTableData"])({
    endpoint: endpoint,
    query: query,
    select: select,
    tableQuery: tableQuery,
  ...
  var extendedTableData = Object(_utils__WEBPACK_IMPORTED_MODULE_22__["extendTableData"])(select, props, queriedTableData);
  return {
  ...
  var _dispatch = dispatch(_woocommerce_data__WEBPACK_IMPORTED_MODULE_18__["EXPORT_STORE_NAME"]),
