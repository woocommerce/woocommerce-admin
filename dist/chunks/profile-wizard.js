...
var selective_extensions_bundle_style = __webpack_require__(567);
...
const SelectiveExtensionsBundle = ({
  ...
  return Object(external_wp_element_["createElement"])("div", {
    ...
    key: sectionKey
  }, isResolving ? Object(external_wp_element_["createElement"])(external_wp_components_["Spinner"], null) : plugins.map(({
    description,
    key
...
var selective_bundle_style = __webpack_require__(568);
...
var business_details_style = __webpack_require__(569);
...
var product_types_style = __webpack_require__(570);
...
var store_details_style = __webpack_require__(571);
...
class store_details_StoreDetails extends external_wp_element_["Component"] {
  ...
  render() {
    ...
    return Object(external_wp_element_["createElement"])("div", {
      ...
      required: true,
      autoComplete: "email"
    }, getInputProps('storeEmail')))), Object(external_wp_element_["createElement"])(external_wp_components_["CardFooter"], null, Object(external_wp_element_["createElement"])(FlexItem, null, Object(external_wp_element_["createElement"])("div", null, Object(external_wp_element_["createElement"])(external_wp_components_["CheckboxControl"], extends_default()({
      label: Object(external_wp_i18n_["__"])('Get tips, product updates and inspiration straight to your mailbox', 'woocommerce-admin')
...
/* harmony default export */ var store_details = (Object(external_wp_compose_["compose"])(Object(external_wp_data_["withSelect"])(select => {
  ...
  const initialValues = {
    ...
    storeEmail: typeof profileItems.store_email === 'string' ? profileItems.store_email : getEmailPrefill()
  };
  return {
    initialValues,
    isLoading,
...
var cloud_upload = __webpack_require__(574);
...
var external_wc_wcSettings_ = __webpack_require__(473);
...
var profile_wizard_style = __webpack_require__(578);
