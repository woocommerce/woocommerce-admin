...
var selective_extensions_bundle_style = __webpack_require__(579);
...
var selective_bundle_style = __webpack_require__(580);
...
var business_details_style = __webpack_require__(581);
...
var product_types_style = __webpack_require__(582);
...
class product_types_ProductTypes extends external_wp_element_["Component"] {
  ...
  onContinue() {
    ...
    if (window.wcAdminFeatures && window.wcAdminFeatures.subscriptions && !installedPlugins.includes('woocommerce-payments') && selected.includes('subscriptions')) {
  ...
  render() {
    ...
    return Object(external_wp_element_["createElement"])("div", {
      ...
      size: "12",
      lineHeight: "16px"
    }, Object(external_wp_i18n_["__"])('Billing is annual. All purchases are covered by our 30 day money back guarantee and include access to support and updates. Extensions will be added to a cart for you to purchase later.', 'woocommerce-admin')), window.wcAdminFeatures && window.wcAdminFeatures.subscriptions && !isWCPayInstalled && selected.includes('subscriptions') && Object(external_wp_element_["createElement"])(external_wc_experimental_["Text"], {
      variant: "body",
      size: "12",
      lineHeight: "16px",
      as: "p"
...
var store_details_style = __webpack_require__(583);
...
var cloud_upload = __webpack_require__(586);
...
var external_wc_wcSettings_ = __webpack_require__(476);
...
var profile_wizard_style = __webpack_require__(590);
