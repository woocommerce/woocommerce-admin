...
const onboarding = Object(wc_admin_settings["f" /* getSetting */])('onboarding', {});
...
var usage_modal = __webpack_require__(559);
...
class theme_Theme extends external_wp_element_["Component"] {
  ...
  activateTheme(slug) {
    ...
    external_wp_apiFetch_default()({
      ...
      Object(wc_admin_settings["g" /* setSetting */])('onboarding', { ...Object(wc_admin_settings["f" /* getSetting */])('onboarding', {}),
...
/* harmony default export */ var profile_wizard = __webpack_exports__["default"] = (Object(external_wp_compose_["compose"])(Object(external_wp_data_["withSelect"])(select => {
  ...
  const connectToJetpack = failureRedirect => {
    connectToJetpackWithFailureRedirect(failureRedirect, createErrorNotice, wc_admin_settings["e" /* getAdminLink */]);
  };
