...
/* harmony import */ var _wordpress_html_entities__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(29);
...
function useGetCountryStateAutofill(options, countryState, setValue) {
  ...
  Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["useEffect"])(() => {
    ...
    const stateSearch = new RegExp(Object(lodash__WEBPACK_IMPORTED_MODULE_5__["escapeRegExp"])(autofillState.replace(/\s/g, '')) + '$', // Always match the end of string for region.
    'i');
...
class store_details_StoreDetails extends external_wp_element_["Component"] {
  ...
  validateStoreDetails(values) {
    ...
    if (!Object(external_wp_url_["isEmail"])(values.storeEmail)) {
