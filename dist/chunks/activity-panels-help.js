...
function getHomeItems() {
  return [{
    ...
    link: 'https://docs.woocommerce.com/document/home-screen/#section-2?utm_medium=product'
  }, {
    title: Object(external_wp_i18n_["__"])('Stats Overview', 'woocommerce-admin'),
    link: 'https://docs.woocommerce.com/document/home-screen/#section-4?utm_medium=product'
  }, {
    title: Object(external_wp_i18n_["__"])('Store Management', 'woocommerce-admin'),
    link: 'https://docs.woocommerce.com/document/home-screen/#section-5?utm_medium=product'
  }, {
    title: Object(external_wp_i18n_["__"])('Store Setup Checklist', 'woocommerce-admin'),
    link: 'https://docs.woocommerce.com/document/woocommerce-setup-wizard/#store-setup-checklist?utm_medium=product'
  }];
}
...
function getMarketingItems(props) {
  ...
  return [activePlugins.includes('mailpoet') && {
    ...
    link: 'https://docs.woocommerce.com/document/google-listings-and-ads/#get-started?utm_medium=product'
...
function getPaymentGatewaySuggestions(props) {
  ...
  return [{
    ...
    link: 'https://docs.woocommerce.com/document/2-0/woocommerce-paypal-payments/#section-3?utm_medium=product'
...
function getShippingItems({
  ...
  return [{
    ...
    link: 'https://docs.woocommerce.com/document/woocommerce-services/#section-3/?utm_source=help_panel&utm_medium=product'
  }, {
...
function getTaxItems(props) {
  ...
  return [{
    ...
    link: 'https://docs.woocommerce.com/document/woocommerce-services/?utm_source=help_panel#section-10?utm_medium=product'
  }].filter(Boolean);
}
