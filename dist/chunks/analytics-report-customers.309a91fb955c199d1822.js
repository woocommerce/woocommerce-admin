...
var filters = Object(_wordpress_hooks__WEBPACK_IMPORTED_MODULE_4__["applyFilters"])(CUSTOMERS_REPORT_FILTERS_FILTER, [{
  ...
  filters: [{
    label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('All Customers', 'woocommerce-admin'),
    value: 'all'
  }, {
    label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('Single Customer', 'woocommerce-admin'),
    ...
    subFilters: [{
      ...
      settings: {
        ...
        labels: {
          placeholder: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('Type to search for a customer', 'woocommerce-admin'),
          button: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('Single Customer', 'woocommerce-admin')
        }
      }
    }]
  }, {
...
var advancedFilters = Object(_wordpress_hooks__WEBPACK_IMPORTED_MODULE_4__["applyFilters"])(CUSTOMERS_REPORT_ADVANCED_FILTERS_FILTER, {
  title: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["_x"])('Customers Match {{select /}} Filters', 'A sentence describing filters for Customers. See screen shot for context: https://cloudup.com/cCsm3GeXJbE', 'woocommerce-admin'),
  filters: {
    name: {
      labels: {
        add: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('Name', 'woocommerce-admin'),
        placeholder: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('Search', 'woocommerce-admin'),
        remove: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('Remove customer name filter', 'woocommerce-admin'),
        rule: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('Select a customer name filter match', 'woocommerce-admin'),

        /* translators: A sentence describing a Product filter. See screen shot for context: https://cloudup.com/cCsm3GeXJbE */
        title: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('{{title}}Name{{/title}} {{rule /}} {{filter /}}', 'woocommerce-admin'),
        filter: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('Select customer name', 'woocommerce-admin')
      },
      rules: [{
        value: 'includes',
        ...
        label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["_x"])('Includes', 'customer names', 'woocommerce-admin')
      }, {
        value: 'excludes',
        ...
        label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["_x"])('Excludes', 'customer names', 'woocommerce-admin')
      }],
      input: {
        component: 'Search',
        type: 'customers',
    ...
    country: {
      labels: {
        add: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('Country / Region', 'woocommerce-admin'),
        placeholder: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('Search', 'woocommerce-admin'),
        remove: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('Remove country / region filter', 'woocommerce-admin'),
        rule: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('Select a country / region filter match', 'woocommerce-admin'),

        /* translators: A sentence describing a Product filter. See screen shot for context: https://cloudup.com/cCsm3GeXJbE */
        title: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('{{title}}Country / Region{{/title}} {{rule /}} {{filter /}}', 'woocommerce-admin'),
        filter: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('Select country / region', 'woocommerce-admin')
      },
      rules: [{
        value: 'includes',
        ...
        label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["_x"])('Includes', 'countries', 'woocommerce-admin')
      }, {
        value: 'excludes',
        ...
        label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["_x"])('Excludes', 'countries', 'woocommerce-admin')
      }],
      input: {
        component: 'Search',
        type: 'countries',
    ...
    email: {
      labels: {
        add: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('Email', 'woocommerce-admin'),
        placeholder: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('Search customer email', 'woocommerce-admin'),
        remove: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('Remove customer email filter', 'woocommerce-admin'),
        rule: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('Select a customer email filter match', 'woocommerce-admin'),

        /* translators: A sentence describing a customer email filter. See screen shot for context: https://cloudup.com/cCsm3GeXJbE */
        title: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('{{title}}Email{{/title}} {{rule /}} {{filter /}}', 'woocommerce-admin'),
        filter: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('Select customer email', 'woocommerce-admin')
      },
      rules: [{
        value: 'includes',
        ...
        label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["_x"])('Includes', 'customer emails', 'woocommerce-admin')
      }, {
        value: 'excludes',
        ...
        label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["_x"])('Excludes', 'customer emails', 'woocommerce-admin')
      }],
      input: {
        component: 'Search',
        type: 'emails',
    ...
    orders_count: {
      labels: {
        add: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('No. of Orders', 'woocommerce-admin'),
        remove: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('Remove order filter', 'woocommerce-admin'),
        rule: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('Select an order count filter match', 'woocommerce-admin'),
        title: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('{{title}}No. of Orders{{/title}} {{rule /}} {{filter /}}', 'woocommerce-admin')
      },
      rules: [{
        value: 'max',
        ...
        label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["_x"])('Less Than', 'number of orders', 'woocommerce-admin')
      }, {
        value: 'min',
        ...
        label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["_x"])('More Than', 'number of orders', 'woocommerce-admin')
      }, {
        value: 'between',
        ...
        label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["_x"])('Between', 'number of orders', 'woocommerce-admin')
      }],
      input: {
        component: 'Number'
      }
    ...
    total_spend: {
      labels: {
        add: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('Total Spend', 'woocommerce-admin'),
        remove: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('Remove total spend filter', 'woocommerce-admin'),
        rule: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('Select a total spend filter match', 'woocommerce-admin'),
        title: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('{{title}}Total Spend{{/title}} {{rule /}} {{filter /}}', 'woocommerce-admin')
      },
      rules: [{
        value: 'max',
        ...
        label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["_x"])('Less Than', 'total spend by customer', 'woocommerce-admin')
      }, {
        value: 'min',
        ...
        label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["_x"])('More Than', 'total spend by customer', 'woocommerce-admin')
      }, {
        value: 'between',
        ...
        label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["_x"])('Between', 'total spend by customer', 'woocommerce-admin')
      }],
      input: {
        component: 'Currency'
      }
    ...
    avg_order_value: {
      labels: {
        add: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('AOV', 'woocommerce-admin'),
        remove: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('Remove average order value filter', 'woocommerce-admin'),
        rule: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('Select an average order value filter match', 'woocommerce-admin'),
        title: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('{{title}}AOV{{/title}} {{rule /}} {{filter /}}', 'woocommerce-admin')
      },
      rules: [{
        value: 'max',
        ...
        label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["_x"])('Less Than', 'average order value of customer', 'woocommerce-admin')
      }, {
        value: 'min',
        ...
        label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["_x"])('More Than', 'average order value of customer', 'woocommerce-admin')
      }, {
        value: 'between',
        ...
        label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["_x"])('Between', 'average order value of customer', 'woocommerce-admin')
      }],
      input: {
        component: 'Currency'
      }
    ...
    registered: {
      labels: {
        add: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('Registered', 'woocommerce-admin'),
        remove: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('Remove registered filter', 'woocommerce-admin'),
        rule: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('Select a registered filter match', 'woocommerce-admin'),

        /* translators: A sentence describing a Product filter. See screen shot for context: https://cloudup.com/cCsm3GeXJbE */
        title: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('{{title}}Registered{{/title}} {{rule /}} {{filter /}}', 'woocommerce-admin'),
        filter: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('Select registered date', 'woocommerce-admin')
      },
      rules: [{
        value: 'before',
        ...
        label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["_x"])('Before', 'date', 'woocommerce-admin')
      }, {
        value: 'after',
        ...
        label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["_x"])('After', 'date', 'woocommerce-admin')
      }, {
        value: 'between',

        /* translators: Sentence fragment, logical, "Between" refers to average order value of a customer, between two given amounts. Screenshot for context: https://cloudup.com/cCsm3GeXJbE */
        label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["_x"])('Between', 'date', 'woocommerce-admin')
      }],
      input: {
        component: 'Date'
      }
    ...
    last_active: {
      labels: {
        add: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('Last active', 'woocommerce-admin'),
        remove: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('Remove last active filter', 'woocommerce-admin'),
        rule: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('Select a last active filter match', 'woocommerce-admin'),

        /* translators: A sentence describing a Product filter. See screen shot for context: https://cloudup.com/cCsm3GeXJbE */
        title: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('{{title}}Last active{{/title}} {{rule /}} {{filter /}}', 'woocommerce-admin'),
        filter: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('Select registered date', 'woocommerce-admin')
      },
      rules: [{
        value: 'before',
