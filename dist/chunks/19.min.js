  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(ReportError, [{
    ...
    value: function render() {
      ...
      if (isError) {
        ...
        actionURL = Object(_woocommerce_wc_admin_settings__WEBPACK_IMPORTED_MODULE_9__["getAdminLink"])('edit.php?post_type=shop_order');
      }
...
/* harmony import */ var _woocommerce_date__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! @woocommerce/date */ "@woocommerce/date");
...
/* harmony import */ var _woocommerce_tracks__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! @woocommerce/tracks */ "@woocommerce/tracks");
...
/* harmony import */ var _customer_effort_score_tracks_data_constants__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ../../../customer-effort-score-tracks/data/constants */ "./client/customer-effort-score-tracks/data/constants.js");
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_2___default()(ReportFilters, [{
    ...
    value: function render() {
      ...
      return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])(_woocommerce_components__WEBPACK_IMPORTED_MODULE_12__["ReportFilters"], {
        query: query,
        siteLocale: _woocommerce_wc_admin_settings__WEBPACK_IMPORTED_MODULE_13__["LOCALE"].siteLocale,
...
ReportFilters.contextType = _lib_currency_context__WEBPACK_IMPORTED_MODULE_17__["CurrencyContext"];
/* harmony default export */ __webpack_exports__["default"] = (Object(_wordpress_compose__WEBPACK_IMPORTED_MODULE_8__["compose"])(Object(_wordpress_data__WEBPACK_IMPORTED_MODULE_11__["withSelect"])(function (select) {
  ...
  var _dispatch = dispatch(_customer_effort_score_tracks_data_constants__WEBPACK_IMPORTED_MODULE_18__["STORE_KEY"]),
...
/* harmony import */ var _woocommerce_csv_export__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! @woocommerce/csv-export */ "@woocommerce/csv-export");
/* harmony import */ var _woocommerce_csv_export__WEBPACK_IMPORTED_MODULE_16___default = /*#__PURE__*/__webpack_require__.n(_woocommerce_csv_export__WEBPACK_IMPORTED_MODULE_16__);
...
/* harmony import */ var _woocommerce_tracks__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! @woocommerce/tracks */ "@woocommerce/tracks");
/* harmony import */ var _woocommerce_tracks__WEBPACK_IMPORTED_MODULE_18___default = /*#__PURE__*/__webpack_require__.n(_woocommerce_tracks__WEBPACK_IMPORTED_MODULE_18__);
/* harmony import */ var _download_icon__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./download-icon */ "./client/analytics/components/report-table/download-icon.js");
/* harmony import */ var _report_error__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ../report-error */ "./client/analytics/components/report-error/index.js");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./utils */ "./client/analytics/components/report-table/utils.js");
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./style.scss */ "./client/analytics/components/report-table/style.scss");
...
var ReportTable = function ReportTable(props) {
  var getHeadersContent = props.getHeadersContent,
      ...
      tableProps = _babel_runtime_helpers_objectWithoutProperties__WEBPACK_IMPORTED_MODULE_4___default()(props, ["getHeadersContent", "getRowsContent", "getSummary", "isRequesting", "primaryData", "tableData", "endpoint", "itemIdField", "tableQuery", "compareBy", "compareParam", "searchBy", "labels"]); // Pull these props out separately because they need to be included in tableProps.
  ...
  var initialSelectedRows = query[compareParam] ? Object(_woocommerce_navigation__WEBPACK_IMPORTED_MODULE_15__["getIdsFromQuery"])(query[compareBy]) : [];
  ...
  var _useUserPreferences = Object(_woocommerce_data__WEBPACK_IMPORTED_MODULE_17__["useUserPreferences"])(),
  ...
  if (isError) {
    return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_5__["createElement"])(_report_error__WEBPACK_IMPORTED_MODULE_20__["default"], {
      isError: true
    });
  }
  ...
  var onPageChange = function onPageChange(newPage, source) {
    ...
    if (source) {
      if (source === 'goto') {
        Object(_woocommerce_tracks__WEBPACK_IMPORTED_MODULE_18__["recordEvent"])('analytics_table_go_to_page', {
          report: endpoint,
          page: newPage
        });
      } else {
        Object(_woocommerce_tracks__WEBPACK_IMPORTED_MODULE_18__["recordEvent"])('analytics_table_page_click', {
          report: endpoint,
          direction: source
        });
      }
  ...
  var trackTableSearch = function trackTableSearch() {
    ...
    Object(_woocommerce_tracks__WEBPACK_IMPORTED_MODULE_18__["recordEvent"])('analytics_table_filter', {
      report: endpoint
    });
  };

  var onSort = function onSort(key, direction) {
    Object(_woocommerce_navigation__WEBPACK_IMPORTED_MODULE_15__["onQueryChange"])('sort')(key, direction);
    var eventProps = {
      report: endpoint,
      column: key,
      direction: direction
    };
    Object(_woocommerce_tracks__WEBPACK_IMPORTED_MODULE_18__["recordEvent"])('analytics_table_sort', eventProps);
  };
  ...
  var applyTableFilters = function applyTableFilters(data, totals, totalResults) {
    ...
    return Object(_wordpress_hooks__WEBPACK_IMPORTED_MODULE_7__["applyFilters"])(TABLE_FILTER, {
      endpoint: endpoint,
  ...
  var onClickDownload = function onClickDownload() {
    ...
    if (data && data.length === totalResults) {
      ...
      Object(_woocommerce_csv_export__WEBPACK_IMPORTED_MODULE_16__["downloadCSVFile"])(Object(_woocommerce_csv_export__WEBPACK_IMPORTED_MODULE_16__["generateCSVFileName"])(title, params), Object(_woocommerce_csv_export__WEBPACK_IMPORTED_MODULE_16__["generateCSVDataFromTable"])(_headers, _rows));
    } else {
      downloadType = 'email';
      startExport(endpoint, reportQuery).then(function () {
        return createNotice('success', Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_12__["sprintf"])(
        /* translators: %s = type of report */
        Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_12__["__"])('Your %s Report will be emailed to you.', 'woocommerce-admin'), title));
      }).catch(function (error) {
        return createNotice('error', error.message || Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_12__["sprintf"])(
        /* translators: %s = type of report */
        Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_12__["__"])('There was a problem exporting your %s Report. Please try again.', 'woocommerce-admin'), title));
      });
    }

    Object(_woocommerce_tracks__WEBPACK_IMPORTED_MODULE_18__["recordEvent"])('analytics_table_download', {
      report: endpoint,
      rows: totalResults,
  ...
  var onCompare = function onCompare() {
    if (compareBy) {
      Object(_woocommerce_navigation__WEBPACK_IMPORTED_MODULE_15__["onQueryChange"])('compare')(compareBy, compareParam, selectedRows.join(','));
    }
  };
  ...
  var onSearchChange = function onSearchChange(values) {
    ...
    if (searchTerms.length) {
      ...
      Object(_woocommerce_navigation__WEBPACK_IMPORTED_MODULE_15__["updateQueryString"])(_objectSpread(_objectSpread((_objectSpread2 = {
        filter: undefined
  ...
  var searchWords = Object(_woocommerce_navigation__WEBPACK_IMPORTED_MODULE_15__["getSearchWords"])(query);
  ...
  var onColumnsChange = function onColumnsChange(shownColumns, toggledColumn) {
    ...
    if (toggledColumn) {
      ...
      Object(_woocommerce_tracks__WEBPACK_IMPORTED_MODULE_18__["recordEvent"])('analytics_table_header_toggle', eventProps);
    }
  ...
  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_5__["createElement"])(_wordpress_element__WEBPACK_IMPORTED_MODULE_5__["Fragment"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_5__["createElement"])("div", {
    ...
    ref: scrollPointRef,
    "aria-hidden": true
  }), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_5__["createElement"])(_woocommerce_components__WEBPACK_IMPORTED_MODULE_14__["TableCard"], _babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0___default()({
    className: 'woocommerce-report-table',
    hasSearch: !!searchBy,
    actions: [compareBy && Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_5__["createElement"])(_woocommerce_components__WEBPACK_IMPORTED_MODULE_14__["CompareButton"], {
      key: "compare",
      className: "woocommerce-table__compare",
      count: selectedRows.length,
      helpText: labels.helpText || Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_12__["__"])('Check at least two items below to compare', 'woocommerce-admin'),
      onClick: onCompare,
      disabled: !downloadable
    }, labels.compareButton || Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_12__["__"])('Compare', 'woocommerce-admin')), searchBy && Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_5__["createElement"])(_woocommerce_components__WEBPACK_IMPORTED_MODULE_14__["Search"], {
      allowFreeTextSearch: true,
      inlineTags: true,
      key: "search",
      onChange: onSearchChange,
      placeholder: labels.placeholder || Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_12__["__"])('Search by item name', 'woocommerce-admin'),
    ...
    }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_5__["createElement"])(_download_icon__WEBPACK_IMPORTED_MODULE_19__["default"], null), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_5__["createElement"])("span", {
      className: "woocommerce-table__download-button__label"
    }, labels.downloadButton || Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_12__["__"])('Download', 'woocommerce-admin')))],
    headers: filteredHeaders,
    isLoading: isLoading,
    onQueryChange: _woocommerce_navigation__WEBPACK_IMPORTED_MODULE_15__["onQueryChange"],
    onColumnsChange: onColumnsChange,
    onSort: onSort,
    onPageChange: onPageChange,
    rows: rows,
    rowsPerPage: parseInt(reportQuery.per_page, 10) || _woocommerce_data__WEBPACK_IMPORTED_MODULE_17__["QUERY_DEFAULTS"].pageSize,
    summary: summary,
...
ReportTable.propTypes = {
   ...
   */
  baseSearchQuery: prop_types__WEBPACK_IMPORTED_MODULE_13___default.a.object,

  /**
   * The string to use as a query parameter when comparing row items.
   */
  compareBy: prop_types__WEBPACK_IMPORTED_MODULE_13___default.a.string,

  /**
   * Url query parameter compare function operates on
   */
  compareParam: prop_types__WEBPACK_IMPORTED_MODULE_13___default.a.string,

  /**
   * The key for user preferences settings for column visibility.
   */
  columnPrefsKey: prop_types__WEBPACK_IMPORTED_MODULE_13___default.a.string,
   ...
   * with `ReportError`.
   */
  endpoint: prop_types__WEBPACK_IMPORTED_MODULE_13___default.a.string,
   ...
   */
  extendItemsMethodNames: prop_types__WEBPACK_IMPORTED_MODULE_13___default.a.shape({
    getError: prop_types__WEBPACK_IMPORTED_MODULE_13___default.a.string,
    isRequesting: prop_types__WEBPACK_IMPORTED_MODULE_13___default.a.string,
    load: prop_types__WEBPACK_IMPORTED_MODULE_13___default.a.string
  }),

  /**
   * Name of store on which extendItemsMethodNames can be found.
   */
  extendedItemsStoreName: prop_types__WEBPACK_IMPORTED_MODULE_13___default.a.string,

  /**
   * A function that returns the headers object to build the table.
   */
  getHeadersContent: prop_types__WEBPACK_IMPORTED_MODULE_13___default.a.func.isRequired,

  /**
   * A function that returns the rows array to build the table.
   */
  getRowsContent: prop_types__WEBPACK_IMPORTED_MODULE_13___default.a.func.isRequired,

  /**
   * A function that returns the summary object to build the table.
   */
  getSummary: prop_types__WEBPACK_IMPORTED_MODULE_13___default.a.func,

  /**
   * The name of the property in the item object which contains the id.
   */
  itemIdField: prop_types__WEBPACK_IMPORTED_MODULE_13___default.a.string,

  /**
   * Custom labels for table header actions.
   */
  labels: prop_types__WEBPACK_IMPORTED_MODULE_13___default.a.shape({
    compareButton: prop_types__WEBPACK_IMPORTED_MODULE_13___default.a.string,
    downloadButton: prop_types__WEBPACK_IMPORTED_MODULE_13___default.a.string,
    helpText: prop_types__WEBPACK_IMPORTED_MODULE_13___default.a.string,
   ...
   */
  primaryData: prop_types__WEBPACK_IMPORTED_MODULE_13___default.a.object,

  /**
   * The string to use as a query parameter when searching row items.
   */
  searchBy: prop_types__WEBPACK_IMPORTED_MODULE_13___default.a.string,

  /**
   * List of fields used for summary numbers. (Reduces queries)
   */
  summaryFields: prop_types__WEBPACK_IMPORTED_MODULE_13___default.a.arrayOf(prop_types__WEBPACK_IMPORTED_MODULE_13___default.a.string),

  /**
   * Table data of that report. If it's not provided, it will be automatically
   * loaded via the provided `endpoint`.
   */
  tableData: prop_types__WEBPACK_IMPORTED_MODULE_13___default.a.object.isRequired,

  /**
   * Properties to be added to the query sent to the report table endpoint.
   */
  tableQuery: prop_types__WEBPACK_IMPORTED_MODULE_13___default.a.object,
...
/* harmony default export */ __webpack_exports__["default"] = (Object(_wordpress_compose__WEBPACK_IMPORTED_MODULE_8__["compose"])(Object(_wordpress_data__WEBPACK_IMPORTED_MODULE_10__["withSelect"])(function (select, props) {
  ...
  var primaryData = getSummary ? Object(_woocommerce_data__WEBPACK_IMPORTED_MODULE_17__["getReportChartData"])({
  ...
  var queriedTableData = tableData || Object(_woocommerce_data__WEBPACK_IMPORTED_MODULE_17__["getReportTableData"])({
    endpoint: endpoint,
    query: query,
    select: select,
  ...
  var extendedTableData = Object(_utils__WEBPACK_IMPORTED_MODULE_21__["extendTableData"])(select, props, queriedTableData);
  return {
  ...
  var _dispatch = dispatch(_woocommerce_data__WEBPACK_IMPORTED_MODULE_17__["EXPORT_STORE_NAME"]),
...
/***/ "./client/lib/currency-context.js":
/*!****************************************!*\
  !*** ./client/lib/currency-context.js ***!
  \****************************************/
/*! exports provided: getFilteredCurrencyInstance, CurrencyContext */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getFilteredCurrencyInstance", function() { return getFilteredCurrencyInstance; });
...
var appCurrency = _woocommerce_currency__WEBPACK_IMPORTED_MODULE_2___default()(_woocommerce_wc_admin_settings__WEBPACK_IMPORTED_MODULE_3__["CURRENCY"]);
