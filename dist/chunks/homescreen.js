...
/* harmony import */ var dompurify__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(44);
...
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(0);
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _placeholder_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(566);
...
/* harmony import */ var _header_activity_panel_activity_card__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(514);
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(164);
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(519);
...
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(0);
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _woocommerce_onboarding__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(272);
...
var build_module = __webpack_require__(272);

// EXTERNAL MODULE: ./client/tasks/task-list.scss
var task_list = __webpack_require__(520);
...
var check = __webpack_require__(476);
...
var tasks_task = __webpack_require__(530);

// EXTERNAL MODULE: ./client/tasks/task-list.tsx + 2 modules
var task_list = __webpack_require__(548);

// EXTERNAL MODULE: ./client/tasks/placeholder.tsx
var placeholder = __webpack_require__(521);
...
var Action = __webpack_require__(546);
...
var notices = __webpack_require__(508);

// EXTERNAL MODULE: ./client/lib/sanitize-html/index.js
var sanitize_html = __webpack_require__(510);
...
var Setup = __webpack_require__(567);
...
var WCPay = __webpack_require__(545);
...
var payment_gateway_suggestions = __webpack_require__(568);
...
var currency_context = __webpack_require__(502);
...
var shipping = __webpack_require__(569);
...
var Marketing = __webpack_require__(570);

// EXTERNAL MODULE: ./client/tasks/fills/Marketing/Plugin.scss
var Plugin = __webpack_require__(571);
...
var PluginList = __webpack_require__(572);
...
var chevron_right = __webpack_require__(474);
...
var product_template_modal = __webpack_require__(573);
 ...
 */
// CONCATENATED MODULE: ./client/tasks/fills/tax/automated-taxes.tsx
...
// CONCATENATED MODULE: ./client/tasks/fills/tax/configuration-stepper/connect.tsx
...
const configuration_stepper_connect_Connect = ({
  onDisable,
  onManual
}) => {
...
// CONCATENATED MODULE: ./client/tasks/fills/tax/configuration-stepper/manual-configuration.tsx
...
// CONCATENATED MODULE: ./client/tasks/fills/tax/configuration-stepper/plugins.tsx
...
// CONCATENATED MODULE: ./client/tasks/fills/tax/configuration-stepper/store-location.tsx
...
// CONCATENATED MODULE: ./client/tasks/fills/tax/configuration-stepper/index.tsx
...
const ConfigurationStepper = ({
  ...
  const getVisibleSteps = () => {
    const allSteps = [{
      ...
      visible: !isResolving && (pluginsToActivate.length || !tosAccepted) && supportsAutomatedTaxes
    }, {
      key: 'connect',
      label: Object(external_wp_i18n_["__"])('Connect your store', 'woocommerce-admin'),
      ...
      content: Object(external_wp_element_["createElement"])(configuration_stepper_connect_Connect, stepProps),
      visible: !isResolving && !isJetpackConnected && supportsAutomatedTaxes
    }, {
      ...
      content: Object(external_wp_element_["createElement"])(ManualConfiguration, stepProps),
      visible: !supportsAutomatedTaxes
    }];
    return Object(external_lodash_["filter"])(allSteps, step => step.visible);
  };
...
// EXTERNAL MODULE: ./client/tasks/fills/tax/tax.scss
var tax = __webpack_require__(574);
...
const Tax = ({
  ...
  const {
    ...
    return {
      ...
      isJetpackConnected: select(external_wc_data_["PLUGINS_STORE_NAME"]).isJetpackConnected(),
      isResolving: !select(external_wc_data_["PLUGINS_STORE_NAME"]).hasFinishedResolution('isJetpackConnected') || !select(external_wc_data_["SETTINGS_STORE_NAME"]).hasFinishedResolution('getSettings', ['general']) || !select(external_wc_data_["ONBOARDING_STORE_NAME"]).hasFinishedResolution('getTasksStatus'),
      ...
      tasksStatus: select(external_wc_data_["ONBOARDING_STORE_NAME"]).getTasksStatus(),
  ...
  const supportsAutomatedTaxes = () => {
    ...
    automatedTaxSupportedCountries.includes(Object(utils["b" /* getCountryCode */])(generalSettings === null || generalSettings === void 0 ? void 0 : generalSettings.woocommerce_default_country));
  };

  const canAutomateTaxes = () => {
    return hasCompleteAddress(generalSettings) && !pluginsToActivate.length && isJetpackConnected && supportsAutomatedTaxes();
  };
  ...
  return Object(external_wp_element_["createElement"])("div", {
    ...
    className: "woocommerce-task-card"
  }, Object(external_wp_element_["createElement"])(external_wp_components_["CardBody"], null, canAutomateTaxes() ? Object(external_wp_element_["createElement"])(AutomatedTaxes, childProps) : Object(external_wp_element_["createElement"])(ConfigurationStepper, childProps))));
};
...
var activity_card = __webpack_require__(514);
...
var client_utils = __webpack_require__(519);
...
var intro_modal_style = __webpack_require__(558);

// EXTERNAL MODULE: ./client/navigation/components/intro-modal/images/nav-intro-1.png
var nav_intro_1 = __webpack_require__(559);
...
var nav_intro_2 = __webpack_require__(560);
...
var nav_intro_3 = __webpack_require__(561);
...
var stats_overview_style = __webpack_require__(562);
...
var store_management_links_style = __webpack_require__(563);

// EXTERNAL MODULE: ./client/store-management-links/quick-link-category/style.scss
var quick_link_category_style = __webpack_require__(564);
...
var quick_link_style = __webpack_require__(565);
...
// EXTERNAL MODULE: ./client/tasks/index.ts + 41 modules
var tasks = __webpack_require__(613);
...
var welcome_from_calypso_modal_style = __webpack_require__(575);
...
var welcome_modal_style = __webpack_require__(576);
...
var homescreen_style = __webpack_require__(577);

// EXTERNAL MODULE: ./client/dashboard/style.scss
var dashboard_style = __webpack_require__(518);
...
const Tasks = Object(external_wp_element_["lazy"])(() => Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 613)));
const TwoColumnTasks = Object(external_wp_element_["lazy"])(() => __webpack_require__.e(/* import() | two-column-tasks */ 52).then(__webpack_require__.bind(null, 624)));
const TwoColumnTasksExtended = Object(external_wp_element_["lazy"])(() => __webpack_require__.e(/* import() | two-column-tasks-extended */ 53).then(__webpack_require__.bind(null, 620)));
const Layout = ({
  ...
  const isRunningTaskListExperiment = (experimentAssignment === null || experimentAssignment === void 0 ? void 0 : experimentAssignment.variationName) === 'treatment';
  ...
  const isRunningTwoColumnExperiment = (twoColExperimentAssignment === null || twoColExperimentAssignment === void 0 ? void 0 : twoColExperimentAssignment.variationName) === 'treatment'; // Override defaultHomescreenLayout if store is in the experiment.
