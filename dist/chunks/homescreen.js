...
/* harmony import */ var _woocommerce_currency__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(125);
...
/* harmony import */ var dompurify__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(101);
...
/* harmony import */ var _woocommerce_components__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(40);
...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(579);
...
var ActivityHeader = /*#__PURE__*/function (_Component) {
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(ActivityHeader, [{
    ...
    value: function render() {
      ...
      }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_5__["createElement"])(_woocommerce_experimental__WEBPACK_IMPORTED_MODULE_8__["Text"], {
        variant: "title.small"
      }, title), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_5__["createElement"])(_woocommerce_experimental__WEBPACK_IMPORTED_MODULE_8__["Text"], {
        variant: "button"
      ...
      }, subtitle && Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_5__["createElement"])(_woocommerce_experimental__WEBPACK_IMPORTED_MODULE_8__["Text"], {
        variant: "body.small"
...
/* harmony import */ var _woocommerce_data__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(21);
...
/* harmony import */ var _woocommerce_number__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(160);
...
function getReportUrl(href, persistedQuery, primaryItem) {
  ...
  if (href === '/jetpack') {
    return Object(_woocommerce_wc_admin_settings__WEBPACK_IMPORTED_MODULE_7__[/* getAdminLink */ "g"])('admin.php?page=jetpack#/dashboard');
  }
...
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(0);
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(593);
...
var style = __webpack_require__(616);

// EXTERNAL MODULE: ./client/store-management-links/quick-link-category/style.scss
var quick_link_category_style = __webpack_require__(617);
...
var quick_link_style = __webpack_require__(618);
...
var store_management_links_StoreManagementLinks = function StoreManagementLinks() {
  var shopUrl = Object(wc_admin_settings["h" /* getSetting */])('shopUrl');
...
"use strict";
var _extends=Object.assign||function(a){for(var c,b=1;b<arguments.length;b++)for(var d in c=arguments[b],c)Object.prototype.hasOwnProperty.call(c,d)&&(a[d]=c[d]);return a};Object.defineProperty(exports,'__esModule',{value:!0});exports.default=function(a){var b=a.size,c=b===void 0?24:b,d=a.onClick,e=a.icon,f=a.className,g=_objectWithoutProperties(a,['size','onClick','icon','className']),j=['gridicon','gridicons-star-outline',f,!!function h(k){return 0==k%18}(c)&&'needs-offset',!1,!1].filter(Boolean).join(' ');return _react2.default.createElement('svg',_extends({className:j,height:c,width:c,onClick:d},g,{xmlns:'http://www.w3.org/2000/svg',viewBox:'0 0 24 24'}),_react2.default.createElement('g',null,_react2.default.createElement('path',{d:'M12 6.308l1.176 3.167.347.936.997.042 3.374.14-2.647 2.09-.784.62.27.963.91 3.25-2.813-1.872-.83-.553-.83.552-2.814 1.87.91-3.248.27-.962-.783-.62-2.648-2.092 3.374-.14.996-.04.347-.936L12 6.308M12 2L9.418 8.953 2 9.257l5.822 4.602L5.82 21 12 16.89 18.18 21l-2.002-7.14L22 9.256l-7.418-.305L12 2z'})))};var _react=__webpack_require__(7),_react2=_interopRequireDefault(_react);function _interopRequireDefault(a){return a&&a.__esModule?a:{default:a}}function _objectWithoutProperties(a,b){var d={};for(var c in a)0<=b.indexOf(c)||Object.prototype.hasOwnProperty.call(a,c)&&(d[c]=a[c]);return d}module.exports=exports['default'];
...
var activity_header = __webpack_require__(578);
...
var style = __webpack_require__(605);
...
var activity_card = __webpack_require__(575);

// EXTERNAL MODULE: ./client/lib/currency-context.js
var currency_context = __webpack_require__(561);

// EXTERNAL MODULE: ./client/homescreen/activity-panel/orders/style.scss
var orders_style = __webpack_require__(607);
      ...
      orders.forEach(function (order) {
        ...
        cards.push(Object(external_wp_element_["createElement"])(activity_card["a" /* ActivityCard */], {
          ...
          onClick: function onClick(_ref3) {
            ...
            if (!target.href) {
              window.location.href = Object(wc_admin_settings["g" /* getAdminLink */])("post.php?action=edit&post=".concat(orderId));
            }
          },
...
var card_ProductStockCard = /*#__PURE__*/function (_Component) {
  ...
  createClass_default()(ProductStockCard, [{
    ...
    value: function render() {
      ...
      var notifyLowStockAmount = Object(wc_admin_settings["h" /* getSetting */])('notifyLowStockAmount', 0);
  ...
  createClass_default()(StockPanel, [{
    ...
    value: function render() {
      ...
      if (isRequesting || !products.length) {
        var numPlaceholders = Math.min(5, countLowStockProducts !== null && countLowStockProducts !== void 0 ? countLowStockProducts : 1);
...
var reviews_style = __webpack_require__(609);
...
var sanitize_html = __webpack_require__(573);
...
var client_utils = __webpack_require__(580);
...
var activity_panel_ActivityPanel = function ActivityPanel() {
  var panelsData = Object(external_wp_data_["useSelect"])(function (select) {
    var totalOrderCount = Object(wc_admin_settings["h" /* getSetting */])('orderCount', 0);
    var orderStatuses = Object(utils["c" /* getOrderStatuses */])(select);
    var reviewsEnabled = Object(wc_admin_settings["h" /* getSetting */])('reviewsEnabled', 'no');
    var countUnreadOrders = Object(utils["d" /* getUnreadOrders */])(select, orderStatuses);
    var manageStock = Object(wc_admin_settings["h" /* getSetting */])('manageStock', 'no');
    var countLowStockProducts = Object(utils["a" /* getLowStockCount */])(select);
    var countUnapprovedReviews = Object(reviews_utils["b" /* getUnapprovedReviews */])(select);
    var publishedProductCount = Object(wc_admin_settings["h" /* getSetting */])('publishedProductCount', 0);
  ...
  var getInitialOpenState = function getInitialOpenState(panelId) {
    var _getUrlParams = Object(client_utils["b" /* getUrlParams */])(window.location.search),
        openedPanel = _getUrlParams.opened_panel;
...
var intro_modal_style = __webpack_require__(611);

// EXTERNAL MODULE: ./client/navigation/components/intro-modal/images/nav-intro-1.png
var nav_intro_1 = __webpack_require__(612);
...
var nav_intro_2 = __webpack_require__(613);
...
var nav_intro_3 = __webpack_require__(614);
...
var external_wc_explat_ = __webpack_require__(161);

// EXTERNAL MODULE: ./client/homescreen/stats-overview/style.scss
var stats_overview_style = __webpack_require__(615);
...
var store_performance_utils = __webpack_require__(581);
    ...
    while (1) {
      switch (_context3.prev = _context3.next) {
        case 0:
          _context3.prev = 0;
          _context3.next = 3;
          return external_wp_data_["controls"].dispatch(STORE_NAME, 'installPlugins', plugins);

        case 3:
          _context3.next = 5;
          return external_wp_data_["controls"].dispatch(STORE_NAME, 'activatePlugins', plugins);
  ...
  return external_regeneratorRuntime_default.a.wrap(function connectToJetpack$(_context4) {
    while (1) {
      switch (_context4.prev = _context4.next) {
        case 0:
          _context4.next = 2;
          return external_wp_data_["controls"].resolveSelect(STORE_NAME, 'getJetpackConnectUrl', {
        ...
        case 2:
          url = _context4.sent;
          _context4.next = 5;
          return external_wp_data_["controls"].resolveSelect(STORE_NAME, 'getPluginsError', 'getJetpackConnectUrl');
    ...
    while (1) {
      switch (_context5.prev = _context5.next) {
        case 0:
          _context5.prev = 0;
          _context5.next = 3;
          return external_wp_data_["controls"].dispatch(STORE_NAME, 'installPlugins', ['jetpack']);

        case 3:
          _context5.next = 5;
          return external_wp_data_["controls"].dispatch(STORE_NAME, 'activatePlugins', ['jetpack']);

        case 5:
          _context5.next = 7;
          return external_wp_data_["controls"].dispatch(STORE_NAME, 'connectToJetpack', getAdminLink);
...
var install_jetpack_cta_InstallJetpackCTA = function InstallJetpackCTA() {
  ...
  var onClickInstall = function onClickInstall() {
    installJetpackAndConnect(actions_createErrorNotice, wc_admin_settings["g" /* getAdminLink */]);
  };
...
var _getSetting = Object(wc_admin_settings["h" /* getSetting */])('dataEndpoints', {
...
var store_management_links = __webpack_require__(598);

// EXTERNAL MODULE: ./client/task-list/placeholder.js
var placeholder = __webpack_require__(592);
...
var welcome_from_calypso_modal_style = __webpack_require__(619);
...
var welcome_modal_style = __webpack_require__(620);
...
var homescreen_style = __webpack_require__(621);

// EXTERNAL MODULE: ./client/dashboard/style.scss
var dashboard_style = __webpack_require__(576);
...
var TaskList = Object(external_wp_element_["lazy"])(function () {
  return Promise.all(/* import() | task-list */[__webpack_require__.e(5), __webpack_require__.e(52)]).then(__webpack_require__.bind(null, 668));
});
var layout_Layout = function Layout(_ref) {
  ...
  var renderColumns = function renderColumns() {
    ...
    }), Object(external_wp_element_["createElement"])(activity_panel_ActivityPanel, null), isTaskListEnabled && renderTaskList(), Object(external_wp_element_["createElement"])(inbox_panel["a" /* default */], null)), Object(external_wp_element_["createElement"])(column_Column, {
      shouldStick: shouldStickColumns
  ...
  var renderTaskList = function renderTaskList() {
    var isSingleTask = Boolean(query.task);
...
var onboardingData = Object(wc_admin_settings["h" /* getSetting */])('onboarding', {});
