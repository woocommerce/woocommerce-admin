...
/* harmony import */ var _header_activity_panel_activity_card__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(556);
...
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(0);
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(585);
...
const StoreManagementLinks = () => {
  const shopUrl = Object(wc_admin_settings["f" /* getSetting */])('shopUrl');
...
var activity_card = __webpack_require__(556);
      ...
      return Object(external_wp_element_["createElement"])(external_wp_element_["Fragment"], null, lib_default()({
        ...
        components: {
          orderLink: Object(external_wp_element_["createElement"])(external_wc_components_["Link"], {
            href: Object(wc_admin_settings["e" /* getAdminLink */])('post.php?action=edit&post=' + orderId),
    ...
    orders.forEach(order => {
      ...
      cards.push(Object(external_wp_element_["createElement"])(activity_card["a" /* ActivityCard */], {
        ...
        onClick: ({
          ...
          if (!target.href) {
            window.location.href = Object(wc_admin_settings["e" /* getAdminLink */])(`post.php?action=edit&post=${orderId}`);
          }
        },
        ...
        order: order,
        orderStatusMap: Object(wc_admin_settings["f" /* getSetting */])('orderStatuses', {})
      })));
    });
    ...
    if (isError) {
      if (!orderStatuses.length) {
        return Object(external_wp_element_["createElement"])(external_wc_components_["EmptyContent"], {
          ...
          actionURL: Object(wc_admin_settings["e" /* getAdminLink */])('admin.php?page=wc-admin&path=/analytics/settings')
        });
      }
...
/* harmony default export */ var activity_panel_orders = (Object(external_wp_data_["withSelect"])((select, props) => {
  ...
  const ordersQuery = {
    ...
    _fields: ['order_id', 'order_number', 'status', 'total_sales', 'total_formatted', 'extended_info.customer', 'extended_info.products']
  };
...
class card_ProductStockCard extends external_wp_element_["Component"] {
  ...
  render() {
    ...
    const notifyLowStockAmount = Object(wc_admin_settings["f" /* getSetting */])('notifyLowStockAmount', 0);
...
class reviews_ReviewsPanel extends external_wp_element_["Component"] {
    ...
    const title = lib_default()({
      ...
      components: {
        ...
        authorLink: Object(external_wp_element_["createElement"])(external_wc_components_["Link"], {
          href: Object(wc_admin_settings["e" /* getAdminLink */])('admin.php?page=wc-admin&path=%2Fcustomers&search=' + review.reviewer),
  ...
  renderReviews(reviews) {
    ...
    return Object(external_wp_element_["createElement"])(external_wp_element_["Fragment"], null, renderedReviews, Object(external_wp_element_["createElement"])(external_wc_components_["Link"], {
      href: Object(wc_admin_settings["e" /* getAdminLink */])('edit-comments.php?comment_type=review'),
...
const ActivityPanel = () => {
  const panelsData = Object(external_wp_data_["useSelect"])(select => {
    const totalOrderCount = Object(wc_admin_settings["f" /* getSetting */])('orderCount', 0);
    const orderStatuses = Object(utils["c" /* getOrderStatuses */])(select);
    const reviewsEnabled = Object(wc_admin_settings["f" /* getSetting */])('reviewsEnabled', 'no');
    const countUnreadOrders = Object(utils["d" /* getUnreadOrders */])(select, orderStatuses);
    const manageStock = Object(wc_admin_settings["f" /* getSetting */])('manageStock', 'no');
    ...
    const publishedProductCount = Object(wc_admin_settings["f" /* getSetting */])('publishedProductCount', 0);
    const {
      getOption
...
const InstallJetpackCTA = () => {
  ...
  const onClickInstall = () => {
    installJetpackAndConnect(createErrorNotice, wc_admin_settings["e" /* getAdminLink */]);
  };
...
var dashboard_style = __webpack_require__(560);
...
const TaskList = Object(external_wp_element_["lazy"])(() => Promise.all(/* import() | task-list */[__webpack_require__.e(1), __webpack_require__.e(49)]).then(__webpack_require__.bind(null, 649)));
const Layout = ({
...
const onboardingData = Object(wc_admin_settings["f" /* getSetting */])('onboarding', {});
