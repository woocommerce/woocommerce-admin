...
var style = __webpack_require__(526);
...
/* harmony import */ var _wordpress_compose__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(14);
...
class Connect extends _wordpress_element__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  constructor(props) {
    super(props);
    this.state = {
      isConnecting: false
  ...
  render() {
    ...
    return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["Fragment"], null, hasErrors ? Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__["Button"], {
      isPrimary: true,
      onClick: () => window.location.reload()
    }, Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__["__"])('Retry', 'woocommerce-admin')) : Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__["Button"], {
      disabled: isRequesting,
      isBusy: this.state.isConnecting,
      isPrimary: true,
      onClick: this.connectJetpack
    }, Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__["__"])('Connect', 'woocommerce-admin')), onSkip && Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__["Button"], {
      onClick: onSkip
    }, skipText || Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__["__"])('No thanks', 'woocommerce-admin')), onAbort && Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__["Button"], {
      onClick: onAbort
    }, abortText || Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__["__"])('Abort', 'woocommerce-admin')));
  }
...
Connect.propTypes = {
   ...
   */
  createNotice: prop_types__WEBPACK_IMPORTED_MODULE_4___default.a.func.isRequired,
   ...
   */
  hasErrors: prop_types__WEBPACK_IMPORTED_MODULE_4___default.a.bool,

  /**
   * Bool to check if the connection URL is still being requested.
   */
  isRequesting: prop_types__WEBPACK_IMPORTED_MODULE_4___default.a.bool,

  /**
   * Generated Jetpack connection URL.
   */
  jetpackConnectUrl: prop_types__WEBPACK_IMPORTED_MODULE_4___default.a.string,

  /**
   * Called before the redirect to Jetpack.
   */
  onConnect: prop_types__WEBPACK_IMPORTED_MODULE_4___default.a.func,
   ...
   */
  onSkip: prop_types__WEBPACK_IMPORTED_MODULE_4___default.a.func,

  /**
   * Redirect URL to encode as a URL param for the connection path.
   */
  redirectUrl: prop_types__WEBPACK_IMPORTED_MODULE_4___default.a.string,

  /**
   * Text used for the skip connection button.
   */
  skipText: prop_types__WEBPACK_IMPORTED_MODULE_4___default.a.string,

  /**
   * Control the `isPending` logic of the parent containing the Stepper.
   */
  setIsPending: prop_types__WEBPACK_IMPORTED_MODULE_4___default.a.func,

  /**
   * Called when the plugin connection is aborted.
   */
  onAbort: prop_types__WEBPACK_IMPORTED_MODULE_4___default.a.func,

  /**
   * Text used for the abort connection button.
   */
  abortText: prop_types__WEBPACK_IMPORTED_MODULE_4___default.a.string
};
Connect.defaultProps = {
  setIsPending: () => {}
};
/* harmony default export */ __webpack_exports__["a"] = (Object(_wordpress_compose__WEBPACK_IMPORTED_MODULE_3__["compose"])(Object(_wordpress_data__WEBPACK_IMPORTED_MODULE_5__["withSelect"])((select, props) => {
  const {
    getJetpackConnectUrl,
    isPluginsRequesting,
    getPluginsError
  } = select(_woocommerce_data__WEBPACK_IMPORTED_MODULE_6__["PLUGINS_STORE_NAME"]);
  const queryArgs = {
...
}), Object(_wordpress_data__WEBPACK_IMPORTED_MODULE_5__["withDispatch"])(dispatch => {
  const {
    createNotice
  } = dispatch('core/notices');
  return {
...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(525);
...
/* harmony import */ var _header_activity_panel_activity_card__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(513);
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(164);
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(518);
/* harmony import */ var _index_scss__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(528);
...
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(0);
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(544);
...
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(4);
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(lodash__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _wordpress_html_entities__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(28);
/* harmony import */ var _wordpress_html_entities__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_wordpress_html_entities__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _wordpress_data__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(7);
/* harmony import */ var _wordpress_data__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_wordpress_data__WEBPACK_IMPORTED_MODULE_6__);
/* harmony import */ var _woocommerce_wc_admin_settings__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(13);
/* harmony import */ var _woocommerce_components__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(21);
...
/* harmony import */ var _woocommerce_data__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(11);
...
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(60);
/* harmony import */ var _lib_sanitize_html__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(508);
/* harmony import */ var _lib_in_app_purchase__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(162);
...
class CartModal extends _wordpress_element__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  constructor(props) {
    super(props);
    this.state = {
  ...
  onClickPurchaseNow() {
    ...
    Object(_woocommerce_tracks__WEBPACK_IMPORTED_MODULE_10__["recordEvent"])('tasklist_modal_proceed_checkout', {
      product_ids: productIds,
      purchase_install: true
    });
    const url = Object(_lib_in_app_purchase__WEBPACK_IMPORTED_MODULE_13__[/* getInAppPurchaseUrl */ "a"])('https://woocommerce.com/cart?utm_medium=product', {
  ...
  renderProducts() {
    ...
    const {
      productTypes = {},
      themes = []
    } = Object(_woocommerce_wc_admin_settings__WEBPACK_IMPORTED_MODULE_7__[/* getSetting */ "f"])('onboarding', {});
    const listItems = [];
    productIds.forEach(productId => {
      const productInfo = Object(lodash__WEBPACK_IMPORTED_MODULE_4__["find"])(productTypes, productType => {
      ...
      const themeInfo = Object(lodash__WEBPACK_IMPORTED_MODULE_4__["find"])(themes, theme => {
        return theme.id === productId;
      });

      if (themeInfo) {
        listItems.push({
          title: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__["sprintf"])(Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__["__"])('%s — %s per year', 'woocommerce-admin'), themeInfo.title, Object(_wordpress_html_entities__WEBPACK_IMPORTED_MODULE_5__["decodeEntities"])(themeInfo.price)),
          content: Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("span", {
            dangerouslySetInnerHTML: Object(_lib_sanitize_html__WEBPACK_IMPORTED_MODULE_12__[/* default */ "a"])(themeInfo.excerpt)
          })
        });
      }
    });
    return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_woocommerce_components__WEBPACK_IMPORTED_MODULE_8__["List"], {
      items: listItems
    });
  }
  ...
  render() {
    ...
    return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__["Modal"], {
      title: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__["__"])('Would you like to add the following paid features to your store now?', 'woocommerce-admin'),
      onRequestClose: () => this.onClose(),
      className: "woocommerce-cart-modal"
    }, this.renderProducts(), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("p", {
      className: "woocommerce-cart-modal__help-text"
    }, Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__["__"])("You won't have access to this functionality until the extensions have been purchased and installed.", 'woocommerce-admin')), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("div", {
    ...
    }, Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__["__"])("I'll do it later", 'woocommerce-admin')), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__["Button"], {
      isPrimary: true,
      isBusy: purchaseNowButtonBusy,
      onClick: () => this.onClickPurchaseNow()
    }, Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__["__"])('Buy now', 'woocommerce-admin'))));
  }

}

/* harmony default export */ __webpack_exports__["a"] = (Object(_wordpress_compose__WEBPACK_IMPORTED_MODULE_2__["compose"])(Object(_wordpress_data__WEBPACK_IMPORTED_MODULE_6__["withSelect"])(select => {
  const {
    getInstalledPlugins
  } = select(_woocommerce_data__WEBPACK_IMPORTED_MODULE_9__["PLUGINS_STORE_NAME"]);
  const {
    getProfileItems
  } = select(_woocommerce_data__WEBPACK_IMPORTED_MODULE_9__["ONBOARDING_STORE_NAME"]);
  const profileItems = getProfileItems();
  const installedPlugins = getInstalledPlugins();
  const productIds = Object(_utils__WEBPACK_IMPORTED_MODULE_11__[/* getProductIdsForCart */ "e"])(profileItems, false, installedPlugins);
  return {
    profileItems,
    productIds
  };
...
var box = __webpack_require__(499);
...
var quick_link_category_style = __webpack_require__(563);
...
var external = __webpack_require__(500);

// EXTERNAL MODULE: external ["wc","components"]
var external_wc_components_ = __webpack_require__(21);

// EXTERNAL MODULE: ./client/store-management-links/quick-link/style.scss
var quick_link_style = __webpack_require__(564);
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "TasksPlaceholder", function() { return /* reexport */ TasksPlaceholder; });
...
const Task = ({
  query
}) => Object(external_wp_element_["createElement"])(build_module["WooOnboardingTask"].Slot, {
  id: query.task,
  fillProps: {
    query
  }
...
const TaskListItem = ({
  ...
  }) : Object(external_wp_element_["createElement"])(DefaultTaskItem, null);
};
...
const TaskList = ({
  ...
  const visibleTasks = tasks.filter(task => task.isVisible && !task.isDismissed && (!task.snoozedUntil || task.snoozedUntil < nowTimestamp));
  const incompleteTasks = tasks.filter(task => task.isVisible && !task.isComplete && !task.isDismissed);
  ...
  const recordTaskListView = () => {
    Object(external_wc_tracks_["recordEvent"])(`${eventPrefix}_view`, {
  ...
  const listProps = isCollapsible ? {
    ...
    expandLabel,
    show: 2,
    onCollapse: () => Object(external_wc_tracks_["recordEvent"])(`${eventPrefix}_collapse`, {}),
    onExpand: () => Object(external_wc_tracks_["recordEvent"])(`${eventPrefix}_expand`, {})
  } : {};
...
// EXTERNAL MODULE: ./client/tasks/placeholder.scss
var placeholder = __webpack_require__(565);

// CONCATENATED MODULE: ./client/tasks/placeholder.tsx
...
const TasksPlaceholder = ({
  ...
  return Object(external_wp_element_["createElement"])("div", {
    ...
    className: "woocommerce-list"
  }, Array.from(new Array(numTasks)).map((v, i) => Object(external_wp_element_["createElement"])("div", {
    key: i,
    className: "woocommerce-list__item has-action"
  }, Object(external_wp_element_["createElement"])("div", {
    className: "woocommerce-list__item-inner"
...
/* harmony default export */ var tasks_placeholder = (TasksPlaceholder);
...
const Tasks = ({
  ...
  const {
    ...
    return {
      isResolving: select(external_wc_data_["ONBOARDING_STORE_NAME"]).isResolving('getTasks'),
  ...
  if (isResolving) {
    return Object(external_wp_element_["createElement"])(TasksPlaceholder, {
      query: query
    });
  }
  ...
  if (currentTask) {
    return Object(external_wp_element_["createElement"])("div", {
      className: "woocommerce-task-dashboard__container"
    }, Object(external_wp_element_["createElement"])(Task, {
      query: query
    }));
  }
...
const Action = ({
  ...
  const ManageButton = () => Object(external_wp_element_["createElement"])(external_wp_components_["Button"], {
    className: classes,
    isSecondary: true,
    role: "button",
    href: manageUrl,
    onClick: () => Object(external_wc_tracks_["recordEvent"])('tasklist_payment_manage', {
      id
    })
  }, Object(external_wp_i18n_["__"])('Manage', 'woocommerce-admin'));

  const SetupButton = () => Object(external_wp_element_["createElement"])(external_wp_components_["Button"], {
    className: classes,
...
const Item = ({
  ...
  }, Object(external_wp_element_["createElement"])(Action, {
    manageUrl: manageUrl,
    id: id,
    hasSetup: hasSetup,
...
var Setup = __webpack_require__(566);
...
const Suggestion = ({
  ...
  return Object(external_wp_element_["createElement"])(build_module["WCPayCard"], null, Object(external_wp_element_["createElement"])(build_module["WCPayCardHeader"], null, installed && needsSetup ? Object(external_wp_element_["createElement"])(build_module["SetupRequired"], null) : Object(external_wp_element_["createElement"])(external_wc_components_["Pill"], null, Object(external_wp_i18n_["__"])('Recommended', 'woocommerce-admin'))), Object(external_wp_element_["createElement"])(build_module["WCPayCardBody"], {
    ...
    lineHeight: "1.5em"
  }, Object(external_wp_element_["createElement"])(TosPrompt, null)), Object(external_wp_element_["createElement"])(Action, {
    id: id,
    hasSetup: true,
    needsSetup: needsSetup,
    isEnabled: isEnabled,
...
var usage_modal = __webpack_require__(510);

// CONCATENATED MODULE: ./client/tasks/fills/PaymentGatewaySuggestions/components/WCPay/UsageModal.js
...
const UsageModal = () => {
  const query = Object(external_wc_navigation_["getQuery"])();
  const shouldDisplayModal = query['wcpay-connection-success'] === '1';
  const [isOpen, setIsOpen] = Object(external_wp_element_["useState"])(shouldDisplayModal);
  ...
  const title = Object(external_wp_i18n_["__"])('Help us build a better WooCommerce Payments experience', 'woocommerce-admin');

  const trackingMessage = lib_default()({
    mixedString: Object(external_wp_i18n_["__"])('By agreeing to share non-sensitive {{link}}usage data{{/link}}, you’ll help us improve features and optimize the WooCommerce Payments experience. You can opt out at any time.', 'woocommerce-admin'),
    components: {
      link: Object(external_wp_element_["createElement"])(external_wc_components_["Link"], {
        href: "https://woocommerce.com/usage-tracking?utm_medium=product",
        target: "_blank",
  ...
  return Object(external_wp_element_["createElement"])(usage_modal["a" /* default */], {
    isDismissible: false,
    title: title,
    message: trackingMessage,
    acceptActionText: Object(external_wp_i18n_["__"])('I agree', 'woocommerce-admin'),
    dismissActionText: Object(external_wp_i18n_["__"])('No thanks', 'woocommerce-admin'),
    onContinue: closeModal,
    onClose: closeModal
  });
};
/* harmony default export */ var WCPay_UsageModal = (UsageModal);
...
const PaymentGatewaySuggestions = ({
  ...
  }, !paymentGateways.size && Object(external_wp_element_["createElement"])(Placeholder, null), !!wcPayGateway.length && Object(external_wp_element_["createElement"])(Suggestion, {
...
var components_connect = __webpack_require__(519);
...
class shipping_Shipping extends external_wp_element_["Component"] {
  ...
  getSteps() {
    ...
    const steps = [{
      ...
      content: Object(external_wp_element_["createElement"])(components_connect["a" /* default */], extends_default()({
...
Object(external_wp_plugins_["registerPlugin"])('wc-admin-onboarding-task-shipping', {
  ...
  render: () => Object(external_wp_element_["createElement"])(build_module["WooOnboardingTask"], {
    id: "shipping"
  }, Object(external_wp_element_["createElement"])(ShippingWrapper, null))
});
// EXTERNAL MODULE: ./client/tasks/fills/Marketing/Marketing.scss
var Marketing = __webpack_require__(567);

// EXTERNAL MODULE: ./client/tasks/fills/Marketing/Plugin.scss
var Plugin = __webpack_require__(568);
...
var PluginList = __webpack_require__(569);
...
const Marketing_Marketing = () => {
  ...
  const {
    ...
    const completedActions = getOption('woocommerce_task_list_tracked_completed_actions') || EMPTY_ARRAY;
    return {
      activePlugins: getActivePlugins(),
      freeExtensions: getFreeExtensions(),
      installedPlugins: getInstalledPlugins(),
      isResolving: !(hasFinishedResolution('getFreeExtensions') && optionFinishedResolution('getOption', ['woocommerce_task_list_tracked_completed_actions'])),
...
Object(external_wp_plugins_["registerPlugin"])('wc-admin-onboarding-task-marketing', {
  ...
  render: () => Object(external_wp_element_["createElement"])(build_module["WooOnboardingTask"], {
    id: "marketing"
  }, Object(external_wp_element_["createElement"])(Marketing_Marketing, null))
});
...
function ProductTemplateModal({
  ...
  if (window.wcAdminFeatures && !window.wcAdminFeatures.subscriptions || !profileItems.product_types.includes('subscriptions') || !installedPlugins.includes('woocommerce-payments')) {
    Object(external_wp_hooks_["addFilter"])(ONBOARDING_PRODUCT_TEMPLATES_FILTER, 'woocommerce-admin', productTemplates => {
      return productTemplates.filter(template => template.key !== 'subscription');
    });
  }
...
const subTasks = [{
  ...
  href: Object(wc_admin_settings_build_module["e" /* getAdminLink */])('edit.php?post_type=product&page=product_importer&wc_onboarding_active_task=product-import')
}, {
  key: 'migrateProducts',
...
Object(external_wp_plugins_["registerPlugin"])('wc-admin-onboarding-task-appearance', {
  ...
  render: () => Object(external_wp_element_["createElement"])(build_module["WooOnboardingTask"], {
    id: "appearance"
  }, Object(external_wp_element_["createElement"])(AppearanceWrapper, null))
});
...
Object(external_wp_plugins_["registerPlugin"])('wc-admin-onboarding-task-connect', {
  ...
  render: () => Object(external_wp_element_["createElement"])(build_module["WooOnboardingTask"], {
    id: "connect"
  }, Object(external_wp_element_["createElement"])(ConnectWrapper, null))
});
// CONCATENATED MODULE: ./client/tasks/fills/tax.js
...
class tax_Tax extends external_wp_element_["Component"] {
  ...
  redirectToTaxSettings() {
    window.location = Object(wc_admin_settings_build_module["e" /* getAdminLink */])('admin.php?page=wc-settings&tab=tax&section=standard&wc_onboarding_active_task=tax');
  }
  ...
  doNotChargeSalesTax() {
    ...
    updateOptions({
      ...
      window.location = Object(wc_admin_settings_build_module["e" /* getAdminLink */])('admin.php?page=wc-admin');
    });
  }
  ...
  getSteps() {
    ...
    const steps = [{
      ...
      content: Object(external_wp_element_["createElement"])(components_connect["a" /* default */], extends_default()({}, this.props, {
        onConnect: () => {
...
const TaxWrapper = Object(external_wp_compose_["compose"])(Object(external_wp_data_["withSelect"])(select => {
  const {
    getSettings,
    isUpdateSettingsRequesting
  } = select(external_wc_data_["SETTINGS_STORE_NAME"]);
...
Object(external_wp_plugins_["registerPlugin"])('wc-admin-onboarding-task-tax', {
  ...
  render: () => Object(external_wp_element_["createElement"])(build_module["WooOnboardingTask"], {
    ...
    query
  }) => Object(external_wp_element_["createElement"])(TaxWrapper, {
    query: query
  }))
});
...
const PurchaseTaskItem = () => {
  ...
  }), cartModalOpen && Object(external_wp_element_["createElement"])(cart_modal["a" /* default */], {
...
var activity_header = __webpack_require__(524);
...
var activity_card = __webpack_require__(513);

// EXTERNAL MODULE: ./client/homescreen/activity-panel/orders/style.scss
var orders_style = __webpack_require__(554);
...
var star_outline = __webpack_require__(555);
...
var reviews_style = __webpack_require__(556);
...
var nav_intro_2 = __webpack_require__(559);
...
var nav_intro_3 = __webpack_require__(560);
...
var stats_overview_style = __webpack_require__(561);
...
var store_performance_utils = __webpack_require__(529);
...
// EXTERNAL MODULE: ./client/tasks/index.ts + 36 modules
var tasks = __webpack_require__(614);
...
var welcome_from_calypso_modal_style = __webpack_require__(571);
...
var welcome_modal_style = __webpack_require__(572);
...
var homescreen_style = __webpack_require__(573);

// EXTERNAL MODULE: ./client/dashboard/style.scss
var dashboard_style = __webpack_require__(517);
...
const TaskList = Object(external_wp_element_["lazy"])(() => __webpack_require__.e(/* import() | task-list */ 51).then(__webpack_require__.bind(null, 628)));
const Tasks = Object(external_wp_element_["lazy"])(() => Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 614)));
const Layout = ({
