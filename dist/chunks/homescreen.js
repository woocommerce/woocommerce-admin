...
const Tax = ({
  ...
  const {
    ...
    return {
      generalSettings: getSettings('general').general,
      isResolving: !hasFinishedResolution('getSettings', ['general']) || !select(external_wc_data_["ONBOARDING_STORE_NAME"]).hasFinishedResolution('getTasksStatus'),
  ...
  return Object(external_wp_element_["createElement"])(Partners, null, partners.map(partner => Object(external_wp_element_["createElement"])(partner.card, {
    key: partner.id,
    ...childProps
  })));
};
