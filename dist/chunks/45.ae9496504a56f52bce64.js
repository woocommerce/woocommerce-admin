...
/* harmony import */ var _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(37);
...
/* harmony import */ var _woocommerce_wc_admin_settings__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(20);
...
var external_this_wc_number_ = __webpack_require__(205);
...
var business_details_BusinessDetails = /*#__PURE__*/function (_Component) {
  ...
  function BusinessDetails(props) {
    ...
    _this.bundleInstall = Object(utils["a" /* getCountryCode */])(settings.woocommerce_default_country) === 'US' && (industrySlugs.includes('fashion-apparel-accessories') || industrySlugs.includes('health-beauty'));
    ...
    value: function renderBusinessExtensionsBundle(values, getInputProps) {
      ...
      return Object(external_this_wp_element_["createElement"])("div", {
        ...
        onClick: function onClick() {
          Object(tracks["b" /* recordEvent */])('storeprofiler_store_business_details_popover');
...
// EXTERNAL MODULE: ./client/profile-wizard/steps/product-types.scss
var product_types = __webpack_require__(910);
...
function getLabel(description, yearlyPrice) {
  ...
  var priceDescription = Object(external_this_wp_i18n_["sprintf"])(Object(external_this_wp_i18n_["__"])('$%f per month, billed annually', 'woocommerce-admin'), monthlyPrice);
  ...
  }, description), Object(external_this_wp_element_["createElement"])(tooltip["a" /* default */], {
    text: Object(external_this_wp_i18n_["__"])("This product type requires a paid extension. We'll add this to a cart so that you can purchase and install it later.", 'woocommerce-admin')
  }, Object(external_this_wp_element_["createElement"])(external_this_wc_components_["Pill"], null, priceDescription)));
}
...
/* harmony default export */ var steps_product_types = (Object(compose["a" /* default */])(Object(external_this_wp_data_["withSelect"])(function (select) {
  var _select = select(external_this_wc_data_["ONBOARDING_STORE_NAME"]),
      getProfileItems = _select.getProfileItems,
      getOnboardingError = _select.getOnboardingError;
...
var store_details_StoreDetails = /*#__PURE__*/function (_Component) {
  ...
  createClass_default()(StoreDetails, [{
    ...
    value: function render() {
      ...
      return Object(external_this_wp_element_["createElement"])(external_this_wp_element_["Fragment"], null, Object(external_this_wp_element_["createElement"])(external_this_wc_components_["H"], {
        className: "woocommerce-profile-wizard__header-title"
      }, Object(external_this_wp_i18n_["__"])('Welcome to WooCommerce', 'woocommerce-admin')), Object(external_this_wp_element_["createElement"])(external_this_wc_components_["H"], {
...
var tab_panel = __webpack_require__(734);

// EXTERNAL MODULE: ./client/profile-wizard/steps/theme/style.scss
var style = __webpack_require__(911);
...
var profile_wizard_style = __webpack_require__(913);
  ...
  createClass_default()(ProfileWizard, [{
    ...
    value: function completeProfiler() {
      ...
      if (shouldConnectJetpack) {
        promises.push(getJetpackConnectUrl({
          redirect_url: Object(client_settings["f" /* getAdminLink */])('admin.php?page=wc-admin')
    ...
    value: function skipProfiler() {
      ...
      updateProfileItems({
        ...
        Object(tracks["b" /* recordEvent */])('storeprofiler_store_details_skip');
        Object(external_this_wc_navigation_["getHistory"])().push(Object(external_this_wc_navigation_["getNewPath"])({}, '/', {}));
      }).catch(function () {
...
/* harmony default export */ var profile_wizard = __webpack_exports__["default"] = (Object(compose["a" /* default */])(Object(with_select["a" /* default */])(function (select) {
  ...
  return {
    ...
    getJetpackConnectUrl: Object(external_this_wp_data_["__experimentalResolveSelect"])(external_this_wc_data_["PLUGINS_STORE_NAME"]).getJetpackConnectUrl,
