...
var OrdersReportTable = /*#__PURE__*/function (_Component) {
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(OrdersReportTable, [{
    ...
    value: function getHeadersContent() {
      return [{
        label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_7__["__"])('Date', 'woocommerce-admin'),
        key: 'date',
        required: true,
        defaultSort: true,
        isLeftAligned: true,
        ...
        label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_7__["__"])('Order #', 'woocommerce-admin'),
        screenReaderLabel: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_7__["__"])('Order Number', 'woocommerce-admin'),
        key: 'order_number',
        required: true
      }, {
        ...
        label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_7__["__"])('Customer', 'woocommerce-admin'),
        key: 'customer_id',
        required: false,
        isSortable: false
      }, {
        label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_7__["__"])('Product(s)', 'woocommerce-admin'),
        screenReaderLabel: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_7__["__"])('Products', 'woocommerce-admin'),
        key: 'products',
        required: false,
        isSortable: false
      }, {
        ...
        label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_7__["__"])('Coupon(s)', 'woocommerce-admin'),
        screenReaderLabel: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_7__["__"])('Coupons', 'woocommerce-admin'),
        key: 'coupons',
        required: false,
        isSortable: false
      }, {
    ...
    value: function getCustomerType(customerType) {
      switch (customerType) {
        case 'new':
          return Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_7__["_x"])('New', 'customer type', 'woocommerce-admin');

        case 'returning':
          return Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_7__["_x"])('Returning', 'customer type', 'woocommerce-admin');

        default:
          return Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_7__["_x"])('N/A', 'customer type', 'woocommerce-admin');
      }
    }
  }, {
    key: "getRowsContent",
      ...
      return Object(lodash__WEBPACK_IMPORTED_MODULE_8__["map"])(tableData, function (row) {
        ...
        return [{
          ...
          display: _this2.renderList(formattedProducts.length ? [formattedProducts[0]] : [], formattedProducts.map(function (product) {
            return {
              label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_7__["sprintf"])(Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_7__["__"])('%s× %s', 'woocommerce-admin'), product.quantity, product.label),
              href: product.href
            };
          })),
          value: formattedProducts.map(function (_ref) {
            var quantity = _ref.quantity,
                label = _ref.label;
            return Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_7__["sprintf"])(Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_7__["__"])('%s× %s', 'woocommerce-admin'), quantity, label);
          }).join(', ')
        }, {
    ...
    value: function getSummary(totals) {
      ...
      return [{
        ...
        label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_7__["_n"])('new customer', 'new customers', numNewCustomers, 'woocommerce-admin'),
        value: Object(_woocommerce_number__WEBPACK_IMPORTED_MODULE_10__["formatValue"])(currency, 'number', numNewCustomers)
      }, {
        label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_7__["_n"])('returning customer', 'returning customers', numReturningCustomers, 'woocommerce-admin'),
        value: Object(_woocommerce_number__WEBPACK_IMPORTED_MODULE_10__["formatValue"])(currency, 'number', numReturningCustomers)
      }, {
        label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_7__["_n"])('product', 'products', products, 'woocommerce-admin'),
        value: Object(_woocommerce_number__WEBPACK_IMPORTED_MODULE_10__["formatValue"])(currency, 'number', products)
      }, {
        label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_7__["_n"])('item sold', 'items sold', numItemsSold, 'woocommerce-admin'),
        value: Object(_woocommerce_number__WEBPACK_IMPORTED_MODULE_10__["formatValue"])(currency, 'number', numItemsSold)
      }, {
        label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_7__["_n"])('coupon', 'coupons', couponsCount, 'woocommerce-admin'),
    ...
    value: function render() {
      ...
      return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_6__["createElement"])(analytics_components_report_table__WEBPACK_IMPORTED_MODULE_13__["default"], {
        ...
        title: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_7__["__"])('Orders', 'woocommerce-admin'),
...
//# sourceMappingURL=analytics-report-orders.52c28a20c82b885d2795.min.js.map