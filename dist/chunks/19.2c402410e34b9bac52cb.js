...
var config = __webpack_require__(746);
...
var table = __webpack_require__(759);
...
var table_variations_getFullVariationName = function getFullVariationName(rowData) {
  return Object(external_lodash_["get"])(rowData, ['extended_info', 'name'], '') + ' - ' + Object(external_lodash_["get"])(rowData, ['extended_info', 'attributes'], []).map(function (_ref) {
  ...
  createClass_default()(VariationsReportTable, [{
    ...
    value: function getRowsContent() {
      ...
      return Object(external_lodash_["map"])(data, function (row) {
        ...
        var name = table_variations_getFullVariationName(row);
        ...
        return [{
          ...
          display: Object(external_this_wc_number_["formatValue"])(getCurrencyConfig(), 'number', itemsSold),
          value: itemsSold
        }, {
...
/* harmony default export */ var report_products = __webpack_exports__["default"] = (Object(compose["a" /* default */])(Object(external_this_wp_data_["withSelect"])(function (select, props) {
