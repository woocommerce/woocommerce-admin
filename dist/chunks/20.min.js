...
/* harmony import */ var _report_error__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ../report-error */ "./client/analytics/components/report-error/index.js");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./utils */ "./client/analytics/components/report-chart/utils.js");
...
var ReportChart = /*#__PURE__*/function (_Component) {
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_2___default()(ReportChart, [{
    ...
    value: function shouldComponentUpdate(nextProps) {
      if (nextProps.isRequesting !== this.props.isRequesting || nextProps.primaryData.isRequesting !== this.props.primaryData.isRequesting || nextProps.secondaryData.isRequesting !== this.props.secondaryData.isRequesting || !Object(lodash__WEBPACK_IMPORTED_MODULE_11__["isEqual"])(nextProps.query, this.props.query)) {
        return true;
      }
    ...
    value: function getTimeChartData() {
      ...
      var currentInterval = Object(_woocommerce_date__WEBPACK_IMPORTED_MODULE_15__["getIntervalForQuery"])(query);
      ...
      var chartData = primaryData.data.intervals.map(function (interval, index) {
        var secondaryDate = Object(_woocommerce_date__WEBPACK_IMPORTED_MODULE_15__["getPreviousDate"])(interval.date_start, primary.after, secondary.after, query.compare, currentInterval);
    ...
    value: function getTimeChartTotals() {
      ...
      return {
        primary: Object(lodash__WEBPACK_IMPORTED_MODULE_11__["get"])(primaryData, ['data', 'totals', selectedChart.key], null),
        secondary: Object(lodash__WEBPACK_IMPORTED_MODULE_11__["get"])(secondaryData, ['data', 'totals', selectedChart.key], null)
      };
    }
  }, {
    key: "renderChart",
    value: function renderChart(mode, isRequesting, chartData, legendTotals) {
      ...
      var currentInterval = Object(_woocommerce_date__WEBPACK_IMPORTED_MODULE_15__["getIntervalForQuery"])(query);
      var allowedIntervals = Object(_woocommerce_date__WEBPACK_IMPORTED_MODULE_15__["getAllowedIntervalsForQuery"])(query);
      var formats = Object(_woocommerce_date__WEBPACK_IMPORTED_MODULE_15__["getDateFormatsForInterval"])(currentInterval, primaryData.data.intervals.length);
      var emptyMessage = emptySearchResults ? Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_7__["__"])('No data for the current search', 'woocommerce-admin') : Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_7__["__"])('No data for the selected date range', 'woocommerce-admin');
      ...
      return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_6__["createElement"])(_woocommerce_components__WEBPACK_IMPORTED_MODULE_13__["Chart"], {
        ...
        tooltipValueFormat: Object(_woocommerce_data__WEBPACK_IMPORTED_MODULE_14__["getTooltipValueFormat"])(selectedChart.type, formatAmount),
        chartType: Object(_woocommerce_date__WEBPACK_IMPORTED_MODULE_15__["getChartTypeForQuery"])(query),
    ...
    value: function renderItemComparison() {
      ...
      if (primaryData.isError) {
        return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_6__["createElement"])(_report_error__WEBPACK_IMPORTED_MODULE_17__["default"], {
          isError: true
        });
      }
...
ReportChart.contextType = _lib_currency_context__WEBPACK_IMPORTED_MODULE_16__["CurrencyContext"];
ReportChart.propTypes = {
  /**
   * Filters available for that report.
   */
  filters: prop_types__WEBPACK_IMPORTED_MODULE_12___default.a.array,
   ...
   */
  itemsLabel: prop_types__WEBPACK_IMPORTED_MODULE_12___default.a.string,

  /**
   * Allows specifying properties different from the `endpoint` that will be used
   * to limit the items when there is an active search.
   */
  limitProperties: prop_types__WEBPACK_IMPORTED_MODULE_12___default.a.array,

  /**
   * `items-comparison` (default) or `time-comparison`, this is used to generate correct
   * ARIA properties.
   */
  mode: prop_types__WEBPACK_IMPORTED_MODULE_12___default.a.string,

  /**
   * Current path
   */
  path: prop_types__WEBPACK_IMPORTED_MODULE_12___default.a.string.isRequired,

  /**
   * Primary data to display in the chart.
   */
  primaryData: prop_types__WEBPACK_IMPORTED_MODULE_12___default.a.object,

  /**
   * The query string represented in object form.
   */
  query: prop_types__WEBPACK_IMPORTED_MODULE_12___default.a.object.isRequired,

  /**
   * Secondary data to display in the chart.
   */
  secondaryData: prop_types__WEBPACK_IMPORTED_MODULE_12___default.a.object,

  /**
   * Properties of the selected chart.
   */
  selectedChart: prop_types__WEBPACK_IMPORTED_MODULE_12___default.a.shape({
    /**
     ...
     */
    order: prop_types__WEBPACK_IMPORTED_MODULE_12___default.a.oneOf(['asc', 'desc']),

    /**
     * Order by query argument.
     */
    orderby: prop_types__WEBPACK_IMPORTED_MODULE_12___default.a.string,

    /**
     * Number type for formatting.
     */
    type: prop_types__WEBPACK_IMPORTED_MODULE_12___default.a.oneOf(['average', 'number', 'currency']).isRequired
  }).isRequired
};
...
/* harmony default export */ __webpack_exports__["default"] = (Object(_wordpress_compose__WEBPACK_IMPORTED_MODULE_8__["compose"])(Object(_wordpress_data__WEBPACK_IMPORTED_MODULE_10__["withSelect"])(function (select, props) {
  ...
  var selectedFilter = Object(_utils__WEBPACK_IMPORTED_MODULE_18__["getSelectedFilter"])(filters, query);
  var filterParam = Object(lodash__WEBPACK_IMPORTED_MODULE_11__["get"])(selectedFilter, ['settings', 'param']);
  var chartMode = props.mode || Object(_utils__WEBPACK_IMPORTED_MODULE_18__["getChartMode"])(selectedFilter, query) || 'time-comparison';
  ...
  var primaryData = Object(_woocommerce_data__WEBPACK_IMPORTED_MODULE_14__["getReportChartData"])({
    endpoint: endpoint,
    dataType: 'primary',
    query: query,
    select: select,
  ...
  var secondaryData = Object(_woocommerce_data__WEBPACK_IMPORTED_MODULE_14__["getReportChartData"])({
    endpoint: endpoint,
    dataType: 'secondary',
    query: query,
    select: select,
