...
var stockStatuses = Object(wc_admin_settings["h" /* getSetting */])('stockStatuses', {});
  ...
  createClass_default()(StockReportTable, [{
    ...
    value: function getRowsContent() {
      ...
      return products.map(function (product) {
        ...
        var editProductLink = Object(wc_admin_settings["g" /* getAdminLink */])('post.php?action=edit&post=' + (parentId || id));
