...
const stockStatuses = Object(build_module["f" /* getSetting */])('stockStatuses', {});
...
class table_StockReportTable extends external_wp_element_["Component"] {
  ...
  getRowsContent(products = []) {
    ...
    return products.map(product => {
      ...
      const editProductLink = Object(build_module["e" /* getAdminLink */])('post.php?action=edit&post=' + (parentId || id));
...
var external_wc_csvExport_ = __webpack_require__(475);
