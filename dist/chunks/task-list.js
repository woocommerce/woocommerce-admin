...
var external_wc_explat_ = __webpack_require__(141);
...
var style = __webpack_require__(585);
...
var sanitize_html = __webpack_require__(554);
...
class cart_modal_CartModal extends external_wp_element_["Component"] {
  ...
  onClickPurchaseNow() {
    ...
    const url = Object(in_app_purchase["a" /* getInAppPurchaseUrl */])('https://woocommerce.com/cart', {
  ...
  renderProducts() {
    ...
    const {
      productTypes = {},
      themes = []
    } = Object(wc_admin_settings["f" /* getSetting */])('onboarding', {});
    const listItems = [];
...
/* harmony default export */ var cart_modal = (Object(external_wp_compose_["compose"])(Object(external_wp_data_["withSelect"])(select => {
  ...
  const productIds = Object(utils["e" /* getProductIdsForCart */])(profileItems, false, installedPlugins);
  return {
    profileItems,
    productIds
  };
...
var chevron_right = __webpack_require__(583);
...
var product_template_modal = __webpack_require__(634);

// EXTERNAL MODULE: ./client/lib/notices/index.js
var notices = __webpack_require__(555);
  ...
  const createTemplate = () => {
    ...
    if (selectedTemplate) {
      createProductFromTemplate({
        ...
        if (data && data.id) {
          const link = Object(wc_admin_settings["e" /* getAdminLink */])(`post.php?post=${data.id}&action=edit&wc_onboarding_active_task=products&tutorial=true`);
...
const subTasks = [{
  ...
  href: Object(wc_admin_settings["e" /* getAdminLink */])('post-new.php?post_type=product&wc_onboarding_active_task=products&tutorial=true')
}, {
  key: 'importProducts',
  ...
  href: Object(wc_admin_settings["e" /* getAdminLink */])('edit.php?post_type=product&page=product_importer&wc_onboarding_active_task=product-import')
}, {
  key: 'migrateProducts',
  ...
  getSteps() {
    ...
    const steps = [{
      ...
      content: Object(external_wp_element_["createElement"])(connect, extends_default()({
        redirectUrl: Object(wc_admin_settings["e" /* getAdminLink */])('admin.php?page=wc-admin'),
...
/* harmony default export */ var shipping = (Object(external_wp_compose_["compose"])(Object(external_wp_data_["withSelect"])(select => {
  ...
  const {
    countries = []
  } = Object(wc_admin_settings["f" /* getSetting */])('dataEndpoints', {});
...
class tax_Tax extends external_wp_element_["Component"] {
  ...
  redirectToTaxSettings() {
    window.location = Object(wc_admin_settings["e" /* getAdminLink */])('admin.php?page=wc-settings&tab=tax&section=standard&wc_onboarding_active_task=tax');
  }
  ...
  doNotChargeSalesTax() {
    ...
    updateOptions({
      ...
      window.location = Object(wc_admin_settings["e" /* getAdminLink */])('admin.php?page=wc-admin');
    });
  }
...
/* harmony default export */ var tax = (Object(external_wp_compose_["compose"])(Object(external_wp_data_["withSelect"])(select => {
  ...
  const tosAccepted = connectOptions.tos_accepted || getOption('woocommerce_setup_jetpack_opted_in');
  const tasksStatus = getTasksStatus();
...
// EXTERNAL MODULE: ./packages/onboarding/build-module/index.js + 21 modules
var build_module = __webpack_require__(315);

// EXTERNAL MODULE: ./client/task-list/tasks/PaymentGatewaySuggestions/components/Action.js
var Action = __webpack_require__(586);
...
const List_List = ({
  ...
  return Object(external_wp_element_["createElement"])(external_wp_components_["Card"], null, Object(external_wp_element_["createElement"])(external_wp_components_["CardHeader"], {
    ...
    return Object(external_wp_element_["createElement"])(Item, {
      ...
      gatewayIds: paymentGateways.map(gateway => gateway.id)
    });
  }));
};
...
var Setup = __webpack_require__(635);
...
const Setup_Setup = ({
  ...
  Object(external_wp_element_["useEffect"])(() => {
    ...
    if (postInstallScripts && postInstallScripts.length) {
      const scriptPromises = postInstallScripts.map(script => Object(wc_admin_settings["d" /* enqueueScript */])(script));
...
var WCPay = __webpack_require__(563);
...
const PaymentGatewaySuggestions = ({
  ...
  const {
    ...
    const installedPaymentGateways = select(external_wc_data_["PAYMENT_GATEWAYS_STORE_NAME"]).getPaymentGateways().reduce((map, gateway) => {
      map[gateway.id] = gateway;
      return map;
    }, {});
    const mappedSuggestions = select(external_wc_data_["ONBOARDING_STORE_NAME"]).getPaymentGatewaySuggestions().reduce((map, suggestion) => {
      const {
        id
      } = suggestion;
      const installedGateway = installedPaymentGateways[suggestion.id] ? installedPaymentGateways[id] : {};
  ...
  const recordConnectStartEvent = Object(external_wp_element_["useCallback"])(gatewayId => {
...
var store_management_links = __webpack_require__(587);
...
var task_list = __webpack_require__(636);
...
const TaskList = ({
  ...
  const [currentTask, setCurrentTask] = Object(external_wp_element_["useState"])((_incompleteTasks$ = incompleteTasks[0]) === null || _incompleteTasks$ === void 0 ? void 0 : _incompleteTasks$.key);
  ...
  return Object(external_wp_element_["createElement"])(external_wp_element_["Fragment"], null, Object(external_wp_element_["createElement"])("div", {
  ...
  })), renderMenu()), Object(external_wp_element_["createElement"])(external_wp_components_["CardBody"], null, Object(external_wp_element_["createElement"])(ListComp, extends_default()({
    animation: "custom"
    ...
    onClick: !expandingItems || task.completed ? task.onClick : () => setCurrentTask(task.key),
    expandable: expandingItems,
    expanded: expandingItems && currentTask === task.key,
...
var placeholder = __webpack_require__(584);
