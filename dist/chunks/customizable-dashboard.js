...
/* harmony import */ var core_js_modules_es_object_keys_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(43);
...
/* harmony import */ var core_js_modules_es_string_match_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(207);
...
/* harmony import */ var _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(21);
...
/* harmony import */ var _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(22);
...
/* harmony import */ var _babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(17);
...
/* harmony import */ var _babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(24);
...
/* harmony import */ var _babel_runtime_helpers_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(25);
...
/* harmony import */ var _babel_runtime_helpers_getPrototypeOf__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(12);
...
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(0);
...
/* harmony import */ var prop_types__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(1);
/* harmony import */ var prop_types__WEBPACK_IMPORTED_MODULE_15___default = /*#__PURE__*/__webpack_require__.n(prop_types__WEBPACK_IMPORTED_MODULE_15__);
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(5);
...
/* harmony import */ var _woocommerce_components__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(148);
...
/* harmony import */ var _woocommerce_data__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(59);
...
/* harmony import */ var _woocommerce_date__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(104);
/* harmony import */ var _woocommerce_date__WEBPACK_IMPORTED_MODULE_21___default = /*#__PURE__*/__webpack_require__.n(_woocommerce_date__WEBPACK_IMPORTED_MODULE_21__);
/* harmony import */ var _woocommerce_tracks__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(92);
/* harmony import */ var _woocommerce_tracks__WEBPACK_IMPORTED_MODULE_22___default = /*#__PURE__*/__webpack_require__.n(_woocommerce_tracks__WEBPACK_IMPORTED_MODULE_22__);
/* harmony import */ var _lib_currency_context__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(606);
/* harmony import */ var _customer_effort_score_tracks_data_constants__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(216);
...
var ReportFilters = /*#__PURE__*/function (_Component) {
  _babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_10___default()(ReportFilters, _Component);
  ...
  function ReportFilters() {
    ...
    _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_7___default()(this, ReportFilters);

    _this = _super.call(this);
    _this.onDateSelect = _this.onDateSelect.bind(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_9___default()(_this));
    _this.onFilterSelect = _this.onFilterSelect.bind(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_9___default()(_this));
    _this.onAdvancedFilterAction = _this.onAdvancedFilterAction.bind(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_9___default()(_this));
    return _this;
  }

  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_8___default()(ReportFilters, [{
    key: "onDateSelect",
    value: function onDateSelect(data) {
      ...
      Object(_woocommerce_tracks__WEBPACK_IMPORTED_MODULE_22__["recordEvent"])('datepicker_update', _objectSpread({
        report: report
      }, Object(lodash__WEBPACK_IMPORTED_MODULE_16__["omitBy"])(data, lodash__WEBPACK_IMPORTED_MODULE_16__["isUndefined"])));
    }
  }, {
    key: "onFilterSelect",
    value: function onFilterSelect(data) {
      ...
      Object(_woocommerce_tracks__WEBPACK_IMPORTED_MODULE_22__["recordEvent"])('analytics_filter', {
        report: report,
    ...
    value: function onAdvancedFilterAction(action, data) {
      ...
      switch (action) {
        case 'add':
          Object(_woocommerce_tracks__WEBPACK_IMPORTED_MODULE_22__["recordEvent"])('analytics_filters_add', {
            report: report,
            filter: data.key
          });
          break;
        ...
        case 'remove':
          Object(_woocommerce_tracks__WEBPACK_IMPORTED_MODULE_22__["recordEvent"])('analytics_filters_remove', {
            report: report,
            filter: data.key
          });
          break;
        ...
        case 'filter':
          var snakeCaseData = Object.keys(data).reduce(function (result, property) {
            result[Object(lodash__WEBPACK_IMPORTED_MODULE_16__["snakeCase"])(property)] = data[property];
            return result;
          }, {});
          addCesSurveyForAnalytics();
          Object(_woocommerce_tracks__WEBPACK_IMPORTED_MODULE_22__["recordEvent"])('analytics_filters_filter', _objectSpread({
            report: report
          }, snakeCaseData));
          break;

        case 'clear_all':
          Object(_woocommerce_tracks__WEBPACK_IMPORTED_MODULE_22__["recordEvent"])('analytics_filters_clear_all', {
            report: report
          });
          break;

        case 'match':
          Object(_woocommerce_tracks__WEBPACK_IMPORTED_MODULE_22__["recordEvent"])('analytics_filters_all_any', {
            report: report,
            value: data.match
          });
          break;
    ...
    value: function render() {
      ...
      var _getDateParamsFromQue = Object(_woocommerce_date__WEBPACK_IMPORTED_MODULE_21__["getDateParamsFromQuery"])(query, defaultDateRange),
          period = _getDateParamsFromQue.period,
          compare = _getDateParamsFromQue.compare,
          before = _getDateParamsFromQue.before,
          after = _getDateParamsFromQue.after;

      var _getCurrentDates = Object(_woocommerce_date__WEBPACK_IMPORTED_MODULE_21__["getCurrentDates"])(query, defaultDateRange),
      ...
      return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_13__["createElement"])(_woocommerce_components__WEBPACK_IMPORTED_MODULE_18__["ReportFilters"], {
        query: query,
        siteLocale: _woocommerce_wc_admin_settings__WEBPACK_IMPORTED_MODULE_19__[/* LOCALE */ "c"].siteLocale,
        ...
        dateQuery: dateQuery,
        isoDateFormat: _woocommerce_date__WEBPACK_IMPORTED_MODULE_21__["isoDateFormat"]
      });
    }
  }]);
...
ReportFilters.contextType = _lib_currency_context__WEBPACK_IMPORTED_MODULE_23__[/* CurrencyContext */ "a"];
/* harmony default export */ __webpack_exports__["a"] = (Object(_wordpress_compose__WEBPACK_IMPORTED_MODULE_14__["compose"])(Object(_wordpress_data__WEBPACK_IMPORTED_MODULE_17__["withSelect"])(function (select) {
  var _select$getSetting = select(_woocommerce_data__WEBPACK_IMPORTED_MODULE_20__["SETTINGS_STORE_NAME"]).getSetting('wc_admin', 'wcAdminSettings'),
      defaultDateRange = _select$getSetting.woocommerce_default_date_range;

  return {
    defaultDateRange: defaultDateRange
  };
}), Object(_wordpress_data__WEBPACK_IMPORTED_MODULE_17__["withDispatch"])(function (dispatch) {
  var _dispatch = dispatch(_customer_effort_score_tracks_data_constants__WEBPACK_IMPORTED_MODULE_24__[/* STORE_KEY */ "c"]),
...
ReportFilters.propTypes = {
   ...
   */
  advancedFilters: prop_types__WEBPACK_IMPORTED_MODULE_15___default.a.object,

  /**
   * Config option passed through to `FilterPicker` - if not used, `FilterPicker` is not displayed.
   */
  filters: prop_types__WEBPACK_IMPORTED_MODULE_15___default.a.array,

  /**
   * The `path` parameter supplied by React-Router
   */
  path: prop_types__WEBPACK_IMPORTED_MODULE_15___default.a.string.isRequired,
   ...
   */
  showDatePicker: prop_types__WEBPACK_IMPORTED_MODULE_15___default.a.bool,

  /**
   * The report where filter are placed.
   */
  report: prop_types__WEBPACK_IMPORTED_MODULE_15___default.a.string.isRequired
};
...
var es_array_splice = __webpack_require__(271);
...
var LazyDashboardCharts = Object(external_wp_element_["lazy"])(function () {
  return Promise.all(/* import() | dashboard-charts */[__webpack_require__.e(6), __webpack_require__.e(30)]).then(__webpack_require__.bind(null, 722));
});
var LazyLeaderboards = Object(external_wp_element_["lazy"])(function () {
  return Promise.all(/* import() | leaderboards */[__webpack_require__.e(1), __webpack_require__.e(35)]).then(__webpack_require__.bind(null, 724));
});
var LazyStorePerformance = Object(external_wp_element_["lazy"])(function () {
  return __webpack_require__.e(/* import() | store-performance */ 49).then(__webpack_require__.bind(null, 716));
});
