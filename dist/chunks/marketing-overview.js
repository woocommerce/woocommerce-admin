...
/* harmony import */ var _woocommerce_experimental__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(37);
...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(338);
...
var button_style = __webpack_require__(337);
...
var product_icon_style = __webpack_require__(339);
...
var slider_style = __webpack_require__(340);
...
var getInAppPurchaseUrl = function getInAppPurchaseUrl(url) {
  ...
  var connectNonce = Object(_woocommerce_wc_admin_settings__WEBPACK_IMPORTED_MODULE_2__[/* getSetting */ "h"])('connectNonce', '');
  queryArgs = _objectSpread({
    'wccom-site': Object(_woocommerce_wc_admin_settings__WEBPACK_IMPORTED_MODULE_2__[/* getSetting */ "h"])('siteUrl'),
    // If the site is installed in a directory the directory must be included in the back param path.
    'wccom-back': pathname + search,
    'wccom-woo-version': Object(_woocommerce_wc_admin_settings__WEBPACK_IMPORTED_MODULE_2__[/* getSetting */ "h"])('wcVersion'),
...
var components = __webpack_require__(140);

// EXTERNAL MODULE: ./client/lib/in-app-purchase.js
var in_app_purchase = __webpack_require__(207);
...
var _getSetting = Object(wc_admin_settings["h" /* getSetting */])('marketing', {}),
...
var installed_extensions_style = __webpack_require__(623);
...
var data = __webpack_require__(341);
...
var overview_MarketingOverview = function MarketingOverview() {
  var allowMarketplaceSuggestions = Object(wc_admin_settings["h" /* getSetting */])('allowMarketplaceSuggestions', false);
  return Object(external_wp_element_["createElement"])("div", {
