...
var thisNumberValue = __webpack_require__(416);
  ...
  createClass_default()(TaxesReportTable, [{
    ...
    value: function getRowsContent(taxes) {
      ...
      return Object(external_lodash_["map"])(taxes, function (tax) {
        ...
        var ordersTaxLink = Object(external_wc_navigation_["getNewPath"])(persistedQuery, '/analytics/orders', {
          filter: 'advanced',
          tax_rate_includes: taxRateId
        });
        var taxLink = Object(external_wp_element_["createElement"])(external_wc_components_["Link"], {
          href: ordersTaxLink,
          type: "wc-admin"
        }, taxCode);
        return [{
...
var taxes_TaxesReport = /*#__PURE__*/function (_Component) {
  ...
  createClass_default()(TaxesReport, [{
    ...
    value: function getChartMeta() {
      ...
      var itemsLabel = Object(external_wp_i18n_["__"])('%d taxes', 'woocommerce-admin');
...
/* harmony default export */ var report_taxes = __webpack_exports__["default"] = (Object(external_wp_data_["withDispatch"])(function (dispatch) {
