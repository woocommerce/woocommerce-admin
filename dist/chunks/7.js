...
/* harmony default export */ var payments_wcpay = (Object(external_wp_data_["withDispatch"])(function (dispatch) {
  var _dispatch = dispatch('core/notices'),
      createNotice = _dispatch.createNotice;
...
var external_wp_url_ = __webpack_require__(74);
  ...
  function PayFast() {
    ...
    defineProperty_default()(assertThisInitialized_default()(_this), "validate", function (values) {
      ...
      if (!values.merchant_key) {
        errors.merchant_key = Object(external_wp_i18n_["__"])('Please enter your merchant key', 'woocommerce-admin');
      }

      if (!values.pass_phrase) {
        errors.pass_phrase = Object(external_wp_i18n_["__"])('Please enter your passphrase', 'woocommerce-admin');
      }
            ...
            switch (_context.prev = _context.next) {
              ...
              case 3:
                ...
                if (update.success) {
                  ...
                  createNotice('success', Object(external_wp_i18n_["__"])('PayFast connected successfully', 'woocommerce-admin'));
                } else {
                  createNotice('error', Object(external_wp_i18n_["__"])('There was a problem saving your payment settings', 'woocommerce-admin'));
                }
  ...
  createClass_default()(PayFast, [{
    ...
    value: function renderConnectStep() {
      ...
      var helpText = lib_default()({
        mixedString: Object(external_wp_i18n_["__"])('Your API details can be obtained from your {{link}}PayFast account{{/link}}', 'woocommerce-admin'),
        components: {
      ...
      return Object(external_wp_element_["createElement"])(external_wc_components_["Form"], {
        ...
        return Object(external_wp_element_["createElement"])(external_wp_element_["Fragment"], null, Object(external_wp_element_["createElement"])(external_wc_components_["TextControl"], extends_default()({
          ...
          label: Object(external_wp_i18n_["__"])('Merchant Key', 'woocommerce-admin'),
          required: true
        }, getInputProps('merchant_key'))), Object(external_wp_element_["createElement"])(external_wc_components_["TextControl"], extends_default()({
          label: Object(external_wp_i18n_["__"])('Passphrase', 'woocommerce-admin'),
          required: true
        }, getInputProps('pass_phrase'))), Object(external_wp_element_["createElement"])(external_wp_components_["Button"], {
          isPrimary: true,
          isBusy: isOptionsRequesting,
          onClick: handleSubmit
    ...
    value: function render() {
      ...
      return Object(external_wp_element_["createElement"])(external_wc_components_["Stepper"], {
        ...
        steps: [installStep, {
          key: 'connect',
          label: Object(external_wp_i18n_["__"])('Connect your PayFast account', 'woocommerce-admin'),
          content: this.renderConnectStep()
        }]
      });
    }
...
/* harmony default export */ var payfast = (Object(external_wp_compose_["compose"])(Object(external_wp_data_["withSelect"])(function (select) {
  var _select = select(external_wc_data_["OPTIONS_STORE_NAME"]),
      isOptionsUpdating = _select.isOptionsUpdating;
...
function getPaymentMethods(_ref) {
  ...
  var methods = [{
    ...
    container: Object(external_wp_element_["createElement"])(payfast, null),
    ...
    container: Object(external_wp_element_["createElement"])(payments_razorpay, null),
  ...
  if (window.wcAdminFeatures.wcpay) {
    var tosLink = Object(external_wp_element_["createElement"])(external_wc_components_["Link"], {
      href: 'https://wordpress.com/tos/',
      target: "_blank",
      type: "external"
    });
    var tosPrompt = lib_default()({
      mixedString: Object(external_wp_i18n_["__"])('By clicking "Set up," you agree to the {{link}}Terms of Service{{/link}}', 'woocommerce-admin'),
      components: {
        link: tosLink
      }
    });
    var wcPayDocLink = Object(external_wp_element_["createElement"])(external_wc_components_["Link"], {
      href: 'https://docs.woocommerce.com/document/payments/testing/dev-mode/',
      target: "_blank",
      type: "external"
    });
    var wcPayDocPrompt = lib_default()({
      mixedString: Object(external_wp_i18n_["__"])('Setting up a store for a client? {{link}}Start here{{/link}}', 'woocommerce-admin'),
      components: {
        link: wcPayDocLink
      }
    });
    var wcPaySettingsLink = Object(external_wp_element_["createElement"])(external_wc_components_["Link"], {
      href: Object(wc_admin_settings["f" /* getAdminLink */])('admin.php?page=wc-settings&tab=checkout&section=woocommerce_payments'),
      type: "wp-admin"
    }, Object(external_wp_i18n_["__"])('Settings', 'woocommerce-admin'));
    methods.unshift({
      key: 'wcpay',
      title: Object(external_wp_i18n_["__"])('WooCommerce Payments', 'woocommerce-admin'),
      content: Object(external_wp_element_["createElement"])(external_wp_element_["Fragment"], null, Object(external_wp_i18n_["__"])('Accept credit card payments the easy way! No setup fees. No ' + 'monthly fees. Just 2.9% + $0.30 per transaction ' + 'on U.S. issued cards. ', 'woocommerce-admin'), wcPayIsConnected && wcPaySettingsLink, !wcPayIsConnected && Object(external_wp_element_["createElement"])("p", null, tosPrompt), profileItems.setup_client && Object(external_wp_element_["createElement"])("p", null, wcPayDocPrompt), Object(external_wp_element_["createElement"])(wcpay_usage_modal["default"], null)),
      ...
      container: Object(external_wp_element_["createElement"])(payments_wcpay, null),
...
/* harmony import */ var _babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(42);
...
/* harmony import */ var _woocommerce_navigation__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(47);
...
/* harmony import */ var _woocommerce_components__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(148);
...
/* harmony import */ var _profile_wizard_steps_usage_modal__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(617);
