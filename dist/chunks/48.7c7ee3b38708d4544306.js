...
var chevron_right = __webpack_require__(736);
...
var tax_Tax = /*#__PURE__*/function (_Component) {
  ...
  createClass_default()(Tax, [{
    ...
    value: function () {
      var _manuallyConfigureTaxRates = asyncToGenerator_default()( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
        var _this2 = this;
...
// EXTERNAL MODULE: ./client/task-list/tasks/payments/methods.js + 10 modules
var payments_methods = __webpack_require__(789);
...
function tasks_getAllTasks(_ref) {
  ...
  var tasks = [{
    ...
    onClick: function () {
      var _onClick = asyncToGenerator_default()( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
  ...
  createClass_default()(TaskDashboard, [{
    ...
    value: function render() {
      ...
      var listTasks = this.getVisibleTasks().map(function (task) {
        ...
        }, task.title, task.time && !task.completed && Object(external_this_wp_element_["createElement"])("span", {
...
/* harmony default export */ var task_list = __webpack_exports__["default"] = (Object(compose["a" /* default */])(Object(with_select["a" /* default */])(function (select) {
  var _select = select(external_this_wc_data_["ONBOARDING_STORE_NAME"]),
      getProfileItems = _select.getProfileItems;
