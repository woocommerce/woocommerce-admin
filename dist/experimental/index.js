...
var TransitionGroupContext = __webpack_require__(52);
...
(function webpackUniversalModuleDefinition(root, factory) {
	if(true)
		module.exports = factory(__webpack_require__(7), __webpack_require__(48));
	else {}
...
__webpack_require__.d(__webpack_exports__, "ListItem", function() { return /* reexport */ experimental_list_item_ExperimentalListItem; });
__webpack_require__.d(__webpack_exports__, "List", function() { return /* reexport */ experimental_list_ExperimentalList; });
__webpack_require__.d(__webpack_exports__, "CollapsibleList", function() { return /* reexport */ collapsible_list_ExperimentalCollapsibleList; });
__webpack_require__.d(__webpack_exports__, "TaskItem", function() { return /* reexport */ task_item_TaskItem; });
__webpack_require__.d(__webpack_exports__, "InboxNoteCard", function() { return /* reexport */ inbox_note_InboxNoteCard; });
__webpack_require__.d(__webpack_exports__, "InboxDismissConfirmationModal", function() { return /* reexport */ inbox_dismiss_confirmation_modal_InboxDismissConfirmationModal; });
__webpack_require__.d(__webpack_exports__, "InboxNotePlaceholder", function() { return /* reexport */ placeholder_InboxNotePlaceholder; });
...
var CSSTransition = __webpack_require__(214);
...
var experimental_list_item_ExperimentalListItem = function ExperimentalListItem(_ref) {
  var children = _ref.children,
      ...
      otherProps = objectWithoutProperties_default()(_ref, ["children", "disableGutters", "animation", "className", "exit", "enter", "onExited", "in"]);
...
var TransitionGroup = __webpack_require__(217);
...
var experimental_list_ExperimentalList = function ExperimentalList(_ref) {
  var children = _ref.children,
      listType = _ref.listType,
      _ref$animation = _ref.animation,
      animation = _ref$animation === void 0 ? 'none' : _ref$animation,
      otherProps = objectWithoutProperties_default()(_ref, ["children", "listType", "animation"]);
  ...
  return Object(external_wp_element_["createElement"])(TransitionGroup["a" /* default */], extends_default()({
  ...
  }, otherProps), external_wp_element_["Children"].map(children, function (child) {
    if (Object(external_wp_element_["isValidElement"])(child)) {
      var _child$props = child.props,
          ...
          remainingProps = objectWithoutProperties_default()(_child$props, ["onExited", "in", "enter", "exit"]);
      ...
      }, Object(external_wp_element_["cloneElement"])(child, _objectSpread({
...
function collapsible_list_ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); if (enumerableOnly) { symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; }); } keys.push.apply(keys, symbols); } return keys; }

function collapsible_list_objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { collapsible_list_ownKeys(Object(source), true).forEach(function (key) { defineProperty_default()(target, key, source[key]); }); } else if (Object.getOwnPropertyDescriptors) { Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)); } else { collapsible_list_ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } } return target; }
...
var collapsible_list_ExperimentalCollapsibleList = function ExperimentalCollapsibleList(_ref) {
  var children = _ref.children,
      ...
      listProps = objectWithoutProperties_default()(_ref, ["children", "collapsed", "collapseLabel", "expandLabel", "show", "onCollapse", "onExpand"]);

  var _useState = Object(external_wp_element_["useState"])(collapsed),
  ...
  var collapseContainerRef = Object(external_wp_element_["useCallback"])(function (containerElement) {
    if (containerElement) {
  ...
  var updateChildren = function updateChildren() {
    var shownChildren = [];
    var allChildren = external_wp_element_["Children"].map(children, function (child) {
      return Object(external_wp_element_["isValidElement"])(child) && 'key' in child ? child : null;
    }) || [];
  ...
  var clickHandler = Object(external_wp_element_["useCallback"])(function () {
  ...
  return Object(external_wp_element_["createElement"])(experimental_list_ExperimentalList, extends_default()({}, listProps, {
    className: listClasses
  }), [].concat(toConsumableArray_default()(displayedChildren.shown), [Object(external_wp_element_["createElement"])(Transition["a" /* default */], {
    ...
    return Object(external_wp_element_["createElement"])("div", {
      ...
      style: collapsible_list_objectSpread(collapsible_list_objectSpread({}, defaultStyle), transitionStyles[state])
    }, displayedChildren.hidden);
  }), displayedChildren.hidden.length > 0 ? Object(external_wp_element_["createElement"])(experimental_list_item_ExperimentalListItem, {
    key: "collapse-item",
...
var check = __webpack_require__(536);

// EXTERNAL MODULE: ./node_modules/gridicons/dist/notice-outline.js
var notice_outline = __webpack_require__(97);
...
var purify = __webpack_require__(101);
...
var task_item_sanitizeHTML = function sanitizeHTML(html) {
  return {
...
var task_item_OptionalTaskTooltip = function OptionalTaskTooltip(_ref) {
...
var task_item_TaskItem = function TaskItem(_ref2) {
  var completed = _ref2.completed,
      title = _ref2.title,
      onDismiss = _ref2.onDismiss,
      remindMeLater = _ref2.remindMeLater,
  ...
  var showEllipsisMenu = (onDismiss || remindMeLater) && !completed;
  return Object(external_wp_element_["createElement"])(experimental_list_item_ExperimentalListItem, {
    disableGutters: true,
    className: className,
    onClick: onClick
  }, Object(external_wp_element_["createElement"])(task_item_OptionalTaskTooltip, {
    level: level,
    completed: completed
    ...
    dangerouslySetInnerHTML: task_item_sanitizeHTML(additionalInfo)
...
var visibility_sensor = __webpack_require__(331);
 ...
 */
var action_InboxNoteActionButton = function InboxNoteActionButton(_ref) {
  ...
  var _useState = Object(external_wp_element_["useState"])(false),
      _useState2 = slicedToArray_default()(_useState, 2),
      inAction = _useState2[0],
      setInAction = _useState2[1];
...
function useCallbackOnLinkClick(onClick) {
  var onNodeClick = Object(external_wp_element_["useCallback"])(function (event) {
    var target = event.target;

    if (target && 'href' in target) {
      var innerLink = target.href;
...
var inbox_note_ALLOWED_TAGS = ['a', 'b', 'em', 'i', 'strong', 'p', 'br'];
var inbox_note_ALLOWED_ATTR = ['target', 'href', 'rel', 'name', 'download'];

var inbox_note_sanitizeHTML = function sanitizeHTML(html) {
  return {
    __html: Object(purify["sanitize"])(html, {
...
var DropdownWithPopoverProps = external_wp_components_["Dropdown"];

var inbox_note_InboxNoteCard = function InboxNoteCard(_ref) {
  var note = _ref.note,
      lastRead = _ref.lastRead,
      onDismiss = _ref.onDismiss,
      onNoteActionClick = _ref.onNoteActionClick,
      onBodyLinkClick = _ref.onBodyLinkClick,
      onNoteVisible = _ref.onNoteVisible,
      className = _ref.className;

  var _useState = Object(external_wp_element_["useState"])(false),
      _useState2 = slicedToArray_default()(_useState, 2),
      clickedActionText = _useState2[0],
      setClickedActionText = _useState2[1];

  var hasBeenSeen = Object(external_wp_element_["useRef"])(false);
  var toggleButtonRef = Object(external_wp_element_["useRef"])(null);
  var linkCallbackRef = useCallbackOnLinkClick(function (innerLink) {
    if (onBodyLinkClick) {
      onBodyLinkClick(note, innerLink);
    }
  }); // Trigger a view Tracks event when the note is seen.

  var onVisible = function onVisible(isVisible) {
  ...
  var handleBlur = function handleBlur(event, onClose) {
    ...
    if (event.relatedTarget) {
      ...
      var ownerDoc = toggleButtonRef.current.ownerDocument;
      relatedTarget = ownerDoc ? ownerDoc.activeElement : null;
    }

    var isClickOutsideDropdown = false;

    if (relatedTarget && 'className' in relatedTarget) {
      var classNames = relatedTarget.className;
      isClickOutsideDropdown = dropdownClasses.some(function (cName) {
        return classNames.includes(cName);
      });
    }
  ...
  var onDropdownDismiss = function onDropdownDismiss(type, onToggle) {
    if (onDismiss) {
      onDismiss(note, type);
    }
  ...
  var renderDismissButton = function renderDismissButton() {
      ...
      renderToggle: function renderToggle(_ref2) {
        ...
        return Object(external_wp_element_["createElement"])(external_wp_components_["Button"], {
          ...
          onBlur: function onBlur(event) {
            return handleBlur(event, onClose);
          }
      ...
      renderContent: function renderContent(_ref3) {
        ...
        return Object(external_wp_element_["createElement"])("ul", null, Object(external_wp_element_["createElement"])("li", null, Object(external_wp_element_["createElement"])(external_wp_components_["Button"], {
          ...
          onClick: function onClick() {
            return onDropdownDismiss('note', onToggle);
          }
          ...
          className: "woocommerce-admin-dismiss-notification",
          onClick: function onClick() {
            return onDropdownDismiss('all', onToggle);
          }
  ...
  var onActionClicked = function onActionClicked(action) {
  ...
  var renderActions = function renderActions() {
    ...
    return Object(external_wp_element_["createElement"])(external_wp_element_["Fragment"], null, noteActions.map(function (action) {
      return Object(external_wp_element_["createElement"])(action_InboxNoteActionButton, {
        key: action.id,
        label: action.label,
        href: action && action.url && action.url.length ? action.url : undefined,
        onClick: function onClick() {
          return onActionClicked(action);
        }
      });
    }));
  };
  ...
  var cardClassName = classnames_default()('woocommerce-inbox-message', className, layout, {
...
var inbox_dismiss_confirmation_modal_InboxDismissConfirmationModal = function InboxDismissConfirmationModal(_ref) {
  var onClose = _ref.onClose,
      onDismiss = _ref.onDismiss,
      _ref$buttonLabel = _ref.buttonLabel,
      buttonLabel = _ref$buttonLabel === void 0 ? Object(external_wp_i18n_["__"])("Yes, I'm sure", 'woocommerce-admin') : _ref$buttonLabel;
...
var placeholder_InboxNotePlaceholder = function InboxNotePlaceholder(_ref) {
...
var Navigation = external_wp_components_["Navigation"] || external_wp_components_["__experimentalNavigation"];
var NavigationBackButton = external_wp_components_["NavigationBackButton"] || external_wp_components_["__experimentalNavigationBackButton"];
var NavigationGroup = external_wp_components_["NavigationGroup"] || external_wp_components_["__experimentalNavigationGroup"];
var NavigationMenu = external_wp_components_["NavigationMenu"] || external_wp_components_["__experimentalNavigationMenu"];
var NavigationItem = external_wp_components_["NavigationItem"] || external_wp_components_["__experimentalNavigationItem"];
var Text = external_wp_components_["Text"] || external_wp_components_["__experimentalText"];
var useSlot = external_wp_components_["useSlot"] || external_wp_components_["__experimentalUseSlot"];
