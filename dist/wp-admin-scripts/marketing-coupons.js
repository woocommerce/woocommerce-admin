...
const {
  installedExtensions
} = Object(wc_admin_settings["f" /* getSetting */])('marketing', {});
const DEFAULT_STATE = {
...
const CouponsOverview = () => {
  const allowMarketplaceSuggestions = Object(wc_admin_settings["f" /* getSetting */])('allowMarketplaceSuggestions', false);
  return Object(external_wp_element_["createElement"])("div", {
