...
var showTaxCompletionNotice = function showTaxCompletionNotice() {
  ...
  saveCompleted(saveButton).then(function () {
    ...
    Object(_wordpress_data__WEBPACK_IMPORTED_MODULE_3__["dispatch"])('core/notices').createSuccessNotice(Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])("You've added your first tax rate!", 'woocommerce-admin'), {
      id: 'WOOCOMMERCE_ONBOARDING_TAX_NOTICE',
      actions: [{
        url: Object(_woocommerce_wc_admin_settings__WEBPACK_IMPORTED_MODULE_5__[/* getAdminLink */ "f"])('admin.php?page=wc-admin'),
        label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('Continue setup.', 'woocommerce-admin')
      }]
    });
  });
};
