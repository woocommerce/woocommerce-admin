...
/* harmony import */ var _wordpress_data__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(26);
...
/* harmony import */ var _wordpress_dom_ready__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(205);
...
/* harmony import */ var _woocommerce_tracks__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(92);
...
var onboardingHomepageNotice = function onboardingHomepageNotice() {
  ...
  saveCompleted().then(function () {
    ...
    Object(_wordpress_data__WEBPACK_IMPORTED_MODULE_2__["dispatch"])('core/notices').removeNotice('SAVE_POST_NOTICE_ID');
    Object(_wordpress_data__WEBPACK_IMPORTED_MODULE_2__["dispatch"])('core/notices').createSuccessNotice(Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__["__"])("🏠 Nice work creating your store's homepage!", 'woocommerce-admin'), {
      id: 'WOOCOMMERCE_ONBOARDING_HOME_PAGE_NOTICE',
      type: notificationType,
      actions: [{
        label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__["__"])('Continue setup.', 'woocommerce-admin'),
        onClick: function onClick() {
          Object(_woocommerce_tracks__WEBPACK_IMPORTED_MODULE_6__["queueRecordEvent"])('tasklist_appearance_continue_setup', {});
          window.location = Object(_woocommerce_wc_admin_settings__WEBPACK_IMPORTED_MODULE_5__[/* getAdminLink */ "f"])('admin.php?page=wc-admin&task=appearance');
        }
      }]
    });
  });
